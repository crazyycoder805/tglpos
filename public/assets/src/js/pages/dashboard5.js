$(function () {
    ...
    //     document.querySelector("#expenses-spark"),
    //     options
    // );
    // chart.render();
    ...
    // var chart = new ApexCharts(
    //     document.querySelector("#Reality-chart"),
    //     options
    // );
    // chart.render();
    ...
    // var chart = new ApexCharts(
    //     document.querySelector("#Reality-chart-2"),
    //     options
    // );
    // chart.render();
    ...
    // var chart = new ApexCharts(
    //     document.querySelector("#successa-rate"),
    //     options
    // );
    // chart.render();
    ...
    // var chart = new ApexCharts(
    //     document.querySelector("#consultation-chart"),
    //     options
    // );
    // chart.render();
    ...
    // var chart = new ApexCharts(
    //     document.querySelector("#recovery_statistics"),
    //     options
    // );
    // chart.render();
});
