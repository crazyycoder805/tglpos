...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:56 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Form Validation </title>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  ...
			  <h6 class="box-subtitle">Bootstrap Form Validation check the <a class="text-primary" href="http://reactiveraven.github.io/jqBootstrapValidation/">official website </a></h6>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
					  ...
					  <div class="row">
						<div class="col-xl-6 col-12">						
							<div class="form-group">
								<label class="form-label">Basic Text Input <span class="text-danger">*</span></label>
								<div class="controls">
							...
							<div class="form-group">
								<label class="form-label">Password Input Field <span class="text-danger">*</span></label>
								<div class="controls">
									<input type="password" name="password" class="form-control" required data-validation-required-message="This field is required"> 
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">Repeat Password Input Field <span class="text-danger">*</span></label>
								<div class="controls">
									<input type="password" name="password2" data-validation-match-match="password" class="form-control" required> 
								</div>
							</div>
							<div class="form-group">
								<label class="form-label">File Input Field <span class="text-danger">*</span></label>
								<div class="controls">
							...
							<div class="form-group">
								<label class="form-label">Maximum Character Length <span class="text-danger">*</span></label>
								<div class="controls">
							...
							<div class="form-group">
								<label class="form-label">Minimum Character Length <span class="text-danger">*</span></label>
								<div class="controls">
						...
						<div class="col-xl-6 col-12">
							...
							<div class="form-group">
								<label class="form-label">Text Input Range <span class="text-danger">*</span></label>
								<div class="controls">
							...
							<div class="form-group">
								<label class="form-label">Input with Button <span class="text-danger">*</span></label>
								<div class="controls">
									<div class="input-group">
							...
							<div class="form-group">
								<label class="form-label">No Characters, Only Numbers <span class="text-danger">*</span></label>
								<div class="controls">
							...
							<div class="form-group">
								<label class="form-label">Pattern <span class="text-danger">*</span> <small><i>Must start with 'a' and end with 'z'</i></small></label>
								<div class="controls">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Checkbox Group <span class="text-danger">*</span></label>
									<div class="controls">
										<fieldset>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Minimum 2 Checkbox selection<span class="text-danger">*</span></label>
									<div class="controls">
										<fieldset>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Radio Buttons <span class="text-danger">*</span></label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-label">Inline Radio Buttons <span class="text-danger">*</span></label>
									<div class="controls">
										<fieldset>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:57 GMT -->
</html>
