...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:20 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Chart Widgets</title>
			...
			<div class="row">
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-12 d-flex flex-column">
									<div class="flex-grow-1 bg-primary p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-15.svg)">
										<h4 class="fw-500">User Confidence</h4>
										<p class="my-10">
											Boost marketing & sales through product confidence.
										</p>
										<a href="#" class="btn btn-warning py-2 px-6">Learn</a>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="d-lg-flex bg-info p-30">
										<div class="d-flex align-items-start me-15 mb-lg-0 mb-30">
											...
											<div class="d-flex flex-column fw-500">
												<a href="#" class="text-white hover-primary fs-16">$800</a>
										...
										<div class="d-flex align-items-start me-15 mb-lg-0 mb-30">
											...
											<div class="d-flex flex-column fw-500">
												<a href="#" class="text-white hover-danger fs-16">$400</a>
										...
										<div class="d-flex align-items-start me-15 mb-lg-0 mb-30">
											...
											<div class="d-flex flex-column fw-500">
												<a href="#" class="text-white hover-success fs-16">$900</a>
										...
										<div class="d-flex align-items-start mb-lg-0 mb-30">
											...
											<div class="d-flex flex-column fw-500">
												<a href="#" class="text-white hover-info fs-16">$80</a>
					...
					<div class="card">
						<div class="card-body">
							<div class="row align-items-center">
								<div class="col-6">
									<h5 class="text-muted fw-normal mt-0 text-muted" title="Campaign Sent">Campaign Sent</h5>
				...
				<div class="col-md-6 col-xxl-3">
					<div class="card">
						<div class="card-body">
							<div class="row align-items-center">
								<div class="col-6">
									<h5 class="text-muted fw-normal mt-0 text-muted" title="New Leads">New Leads</h5>
				...
				<div class="col-md-6 col-xxl-3">
					<div class="card">
						<div class="card-body">
							<div class="row align-items-center">
								<div class="col-6">
									<h5 class="text-muted fw-normal mt-0 text-muted" title="Booked Revenue">Booked Revenue</h5>
				...
				<div class="col-12 col-xl-4">
					<div class="box">		
						...
						<div class="box-body px-0 bg-danger rounded-0">	
							<div id="spark5" class="text-dark"></div>
						</div>
				...
				<div class="col-12 col-xl-4">
					<div class="box">		
						...
						<div class="box-body px-0 bg-primary rounded-0">	
							<div id="spark6" class="text-dark"></div>
						</div>
						<div class="box-body up-mar60 pb-0">	
							<div class="row">
								<div class="col-6">
				...
				<div class="col-12 col-xl-4">
					<div class="box">		
						...
						<div class="box-body px-0 bg-success rounded-0">	
							<div id="spark7" class="text-dark"></div>
						</div>
						<div class="box-body up-mar60 pb-0">	
							<div class="row">
								<div class="col-6">
				...
				<div class="col-12 col-xl-4">
					<div class="box chart-widget">		
						<div class="box-header no-border bg-info">
							...
							<ul class="box-controls pull-right">
							  <li class="dropdown">
								<a data-bs-toggle="dropdown" href="#" class="btn btn-info-light px-10 base-font">Export</a>
								<div class="dropdown-menu dropdown-menu-end">
								  <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
								  <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
								  <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
						...
						<div class="box-body px-0 py-0 bg-info rounded-0">	
				...
				<div class="col-12 col-xl-4">
					<div class="box chart-widget">		
						...
						<div class="box-body px-0 py-0 bg-primary rounded-0">	
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_chart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:21 GMT -->
</html>
