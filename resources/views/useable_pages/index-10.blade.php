...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:14 GMT -->
<head>
		<meta charset="utf-8">
					...
					<div class="row">
							...
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center">
										<div class="w-60 h-60 bg-primary-light rounded text-center fs-24 l-h-60 me-10"><i class="fa fa-shopping-cart"></i></div>
										<div>
											<p class="fs-16 text-fade m-0">New Orders</p>
											<h3 class="my-0 fw-600">4,526+</h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center">
										<div class="w-60 h-60 bg-danger-light rounded text-center fs-24 l-h-60 me-10"><i class="mdi mdi-checkbox-multiple-marked-outline"></i></div>
										<div>
											<p class="fs-16 text-fade m-0">Approval Panding</p>
											<h3 class="my-0 fw-600">50</h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center">
										<div class="w-60 h-60 bg-warning-light rounded text-center fs-24 l-h-60 me-10"><i class="fa fa-clock-o"></i></div>
										<div>
											<p class="fs-16 text-fade m-0">Waiting Time</p>
											<h3 class="my-0 fw-600">3h 30m</h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center">
										<div class="w-60 h-60 bg-success-light rounded text-center fs-24 l-h-60 me-10"><i class="mdi mdi-archive"></i></div>
										<div>
											<p class="fs-16 text-fade m-0">Limit Access</p>
											<h3 class="my-0 fw-600">60%</h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-6 col-12">
							<div class="box">
								<div class="box-header no-border d-flex justify-content-between align-items-center">
									<h4 class="box-title m-0">Inventory Volumes</h4>
									<div class="btn-group">
									  	<button class="btn btn-md btn-outline-dark dropdown-toggle" type="button" data-bs-toggle="dropdown">Last 1 Month</button>
									  	<div class="dropdown-menu">
											<a class="dropdown-item" href="#">3 Month</a>
											<a class="dropdown-item" href="#">6 Month</a>
						...
						<div class="col-xxl-3 col-xl-6 col-lg-6 col-12">
							<div class="box">
								<div class="box-header no-border d-flex justify-content-between align-items-center">
									<h4 class="box-title m-0">Inventory Carrying Cost</h4>
								</div>
								<div class="box-body py-0 ps-0 pe-10">
									<div id="chart-container" class="h-300"></div>
								</div>								
							</div>
						</div>	
						<div class="col-xxl-3 col-xl-6 col-lg-6 col-12">
							<div class="box">
								<div class="box-header no-border d-flex justify-content-between align-items-center">
									<h4 class="box-title m-0">Inventory Turnover</h4>
								</div>
								<div class="box-body py-0 ps-0 pe-10">
									<div id="chart-container-2" class="h-300"></div>
								</div>								
							</div>
						</div>
						<div class="col-xl-4 col-12">
							<div class="box" id="bt-sellers">
								...
								<div class="box-body px-0 py-0">
									<div class="inner-user-div3 px-20 py-20">
										<div class="b-1 box-shadowed p-10 mb-10 rounded10">
									...
									<div class="table-responsive">
									  <table class="table mb-0">
										<tr>
										  ...
										  <td><span class="text-muted text-nowrap"><i class="fa fa-calendar-o text-success-light mx-5"></i> 05-12-2024</span> </td>
										  <td>
											  <div class="d-flex align-items-center">
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard10.js"></script>

	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:15 GMT -->
</html>
