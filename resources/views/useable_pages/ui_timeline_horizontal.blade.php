...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_timeline_horizontal.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:45 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Horizontal Timeline</title>
						...
						<div class="events-wrapper">
							<div class="events">
								<ol>
									...
									<li><a href="#0" data-date="20/05/2021">20 May</a></li>
									<li><a href="#0" data-date="09/07/2021">09 Jul</a></li>
									<li><a href="#0" data-date="30/08/2021">30 Aug</a></li>
									<li><a href="#0" data-date="15/09/2021">15 Sep</a></li>
									<li><a href="#0" data-date="01/11/2021">01 Nov</a></li>
									<li><a href="#0" data-date="10/12/2021">10 Dec</a></li>
									<li><a href="#0" data-date="19/01/2022">29 Jan</a></li>
									<li><a href="#0" data-date="03/03/2022">3 Mar</a></li>
					...
					<div class="events-content">
						<ol>
							<li class="selected" data-date="16/01/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-1.png"> Horizontal Timeline<br/><small class="text-fade">January 16th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							</li>
							<li data-date="28/02/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-2.png"> Horizontal Timeline<br/><small class="text-fade">Feb 28th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="20/04/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-3.png"> Horizontal Timeline<br/><small class="text-fade">March 20th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="20/05/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-4.png"> Horizontal Timeline<br/><small class="text-fade">May 20th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="09/07/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-5.png"> Horizontal Timeline<br/><small class="text-fade">July 9th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="30/08/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-6.png"> Horizontal Timeline<br/><small class="text-fade">August 30th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="15/09/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-7.png"> Horizontal Timeline<br/><small class="text-fade">September 15th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="01/11/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-8.png"> Horizontal Timeline<br/><small class="text-fade">November 01st, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="10/12/2021">
								<h3><img class="img-responsive bg-light rounded pull-left me-20 mb-10" width="60" alt="user" src="../../../images/avatar/avatar-9.png"> Horizontal Timeline<br/><small class="text-fade">December 10th, 2021</small></h3>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="19/01/2022">
								<h3>Event title here</h3> <em class="fs-18 text-fade">January 19th, 2022</em>
								<hr class="mt-30 mb-20">
								<p class="pb-20 text-fade"> On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.<br>
									<button class="btn btn-primary btn-outline mt-20">Read more</button>
								</p>
							...
							<li data-date="03/03/2022">
								<h3>Event title here</h3> <em class="fs-18 text-fade">March 3rd, 2022</em>
								<hr class="mt-30 mb-20">
...
<!-- ./wrapper -->
    ...
    <script src="../../../assets/icons/feather-icons/feather.min.js"></script>	<script src="../../../assets/vendor_components/horizontal-timeline/js/horizontal-timeline.js"></script>
