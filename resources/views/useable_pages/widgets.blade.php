...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:26 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Widgets</title>
		...
		<section class="content">
		  ...
		  <div class="row">				  
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-info-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/001-glass.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-danger-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/008-python.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-primary-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/007-color-palette.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
			...
			<div class="col-xl-6"> 
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 p-30 flex-grow-1 bg-img" style="background-position: left bottom; background-size: auto 80%; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-2.svg)">
							<div class="row">
								...
								<div class="col-12 col-xl-5">
									...
									<a href="#" class="btn btn-primary-light">Join Now!</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-xl-3">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-3.svg)">
			...
			<div class="col-xl-3">
				<div class="box">
					<div class="box-body d-flex p-0">
					<div class="flex-grow-1 bg-primary p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-4.svg)">
			...
			<div class="col-xl-4">				
				<div class="box">
					<div class="card-body d-flex p-0">
						<div class="flex-grow-1 px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: calc(100% + 0.5rem) bottom; background-size: 30% auto; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-5.svg)">
			...
			<div class="col-xl-4">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-info px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: right bottom; background-size: 40% auto; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-6.svg)">
			...
			<div class="col-xl-4">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-danger px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: calc(100% + 0.5rem) bottom; background-size: 30% auto; background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/custom-7.svg)">
							...
							<a href="#" class="btn btn-danger-light">Join Now</a>
						</div>
					</div>
				</div>
			</div>
							...
							<table class="table no-border table-vertical-center">
								...
								<tbody>
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/001-glass.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
									...
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/002-google.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
									...
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/003-settings.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
									...
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/006-pottery.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
									...
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/005-paint-palette.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
											<a href="#" class="text-dark fw-600 hover-primary fs-16">Duis faucibus lorem</a>
							...
							<table class="table no-border">
								...
								<tbody>
									<tr>										
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/007-color-palette.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
											<a href="#" class="text-dark fw-600 hover-primary fs-16">Vivamus consectetur</a>
							...
							<table class="table no-border">
								...
								<tbody>
									<tr>										
										...
										<td class="text-end">
											<a href="#" class="waves-effect waves-light btn btn-primary btn-circle mx-5"><span class="fa fa-bookmark"></span></a>
											<a href="#" class="waves-effect waves-light btn btn-primary btn-circle mx-5"><span class="fa fa-arrow-right"></span></a>
										</td>
									</tr>
									<tr>										
										<td class="ps-0 py-8">
					...
					<div class="box-body">
						...
						<div class="row row-cols-2 g-2">
							<div class="col text-center">								
								<button class="btn btn-twitter text-white">Invite from Twitter <i class="fa-brands fa-x-twitter ms-10"></i></button>
							</div>
							<div class="col text-center">
					...
					<div class="box-body p-0">
						<div class="media-list media-list-hover media-list-divided">
							<div class="media media-single">
							  <a href="#">
								<img class="avatar avatar-lg bg-light" src="../../../images/avatar/avatar-12.png" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#">
								<img class="avatar avatar-lg bg-light" src="../../../images/avatar/avatar-10.png" alt="...">
							  </a>
							  <div class="media-body">
							...
							<div class="media media-single">
							  <a href="#">
								<img class="avatar avatar-lg bg-light" src="../../../images/avatar/avatar-1.png" alt="...">
							  </a>
							  <div class="media-body">
				...
				<div class="box-body">
				  ...
				  <div class="direct-chat-messages">
					...
					<div class="direct-chat-msg mb-30">
					  <div class="clearfix mb-15">
						...
						<span class="direct-chat-timestamp pull-right">April 14, 2023</span>
					  </div>
					  <!-- /.direct-chat-info -->
					  <img class="direct-chat-img avatar bg-light" src="../../../images/avatar/avatar-12.png" alt="message user image">
					  <!-- /.direct-chat-img -->
				  ...
				  <div class="direct-chat-contacts">
					<ul class="contacts-list">
					  <li>
						<a href="#">
						  <img class="contacts-list-img bg-light" src="../../../images/avatar/avatar-10.png" alt="User Image">

						  <div class="contacts-list-info">
								<span class="contacts-list-name">
								  Bryson
								  <small class="contacts-list-date pull-right">April 14, 2023</small>
								</span>
					  ...
					  <li>
						<a href="#">
						  <img class="contacts-list-img bg-light" src="../../../images/avatar/avatar-1.png" alt="User Image">

						  <div class="contacts-list-info">
								<span class="contacts-list-name">
								  Vincent
								  <small class="contacts-list-date pull-right">March 14, 2023</small>
								</span>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/widgets.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:27 GMT -->
</html>
