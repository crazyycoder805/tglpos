...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/invoicelist_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:42 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Invoice List </title>
				...
				<div class="box">
					...
					<div class="box-body">						
						<div class="table-responsive">
							...
							<table id="example" class="text-fade table table-lg invoice-archive">
								<thead>
									<tr class="text-dark">
										<th>Invoice Id</th>
										<th>Issued to</th>
								...
								<tbody>
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Jacob</a>
											</p>
										</td>
										<td>
										...
										<td>
											<span class="badge badge-pill badge-success">Paid on Mar 16, 2021</span>
										</td>
										<td>
											<p class="mb-0 text-dark">$36,890</p>
										</td>
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Mason</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
										...
										<td>
											<p class="mb-0 text-dark">$8,854</p>
										</td>
										<td class="text-center">
											<div class="list-icons d-inline-flex">
												<a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">William</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
										...
										<td>
											<p class="mb-0 text-dark">$12,854</p>
										</td>
										<td class="text-center">
											<div class="list-icons d-inline-flex">
												<a href="#" class="list-icons-item me-10"><i class="fa fa-eye-slash"></i></a>
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Jayden</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Ethan</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Alexander</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Aiden</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Daniel</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Anthony</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Matthew</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
									...
									<tr>
										...
										<td>
											<p class="mb-0">
												<a href="#" class="text-fade">Elijah</a>
											</p>
										</td>
										<td>
											<select name="status" class="form-select" data-placeholder="Select status">
