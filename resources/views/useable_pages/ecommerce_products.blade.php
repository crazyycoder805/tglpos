...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ecommerce_products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:37 GMT -->
<head>
  <meta charset="utf-8">
						...
						<div class="box-body">
							<form>
								...
								<div class="form-group mb-30">
									...
									<div class="checkbox-list">
										<input type="text" value="" class="slider form-control" data-slider-min="-200" data-slider-max="200" data-slider-step="5" data-slider-value="[-100,100]" data-slider-orientation="horizontal" data-slider-selection="before" data-slider-tooltip="show" data-slider-id="primary">
									</div>
								</div>
							...
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										...
										<img src="../../../images/product/product-1.png" alt="" class="img-fluid">
									...
									<div class="mt-30 pro-dec text-center">
										<h5 class="fw-500"><a href="#">Product Name</a></h5>
							...
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										...
										<img src="../../../images/product/product-2.png" alt="" class="img-fluid">
										<div class="overlay-layer">
											<a href="#" class="btn btn-sm btn-primary me-2">Quick View</a>
											<a href="#" class="btn btn-sm btn-primary-light">Purchase</a>
										</div>
							...
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										...
										<img src="../../../images/product/product-3.png" alt="" class="img-fluid">
										<div class="overlay-layer">
											<a href="#" class="btn btn-sm btn-primary me-2">Quick View</a>
											<a href="#" class="btn btn-sm btn-primary-light">Purchase</a>
										</div>
							...
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										...
										<img src="../../../images/product/product-4.png" alt="" class="img-fluid">
										<div class="overlay-layer">
											<a href="#" class="btn btn-sm btn-primary me-2">Quick View</a>
											<a href="#" class="btn btn-sm btn-primary-light">Purchase</a>
										</div>
						...
						<div class="col-xl-4 col-md-6 col-12">
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										<div class="position-absolute r-0"><span class="bg-primary-light avatar rounded10">-15%</span></div>
										<img src="../../../images/product/product-5.png" alt="" class="img-fluid">
										<div class="overlay-layer">
											<a href="#" class="btn btn-sm btn-primary me-2">Quick View</a>
											<a href="#" class="btn btn-sm btn-primary-light">Purchase</a>
										</div>
							...
							<div class="box">
								<div class="box-body">
									<div class="overlay position-relative">
										...
										<img src="../../../images/product/product-6.png" alt="" class="img-fluid">
										<div class="overlay-layer">
											<a href="#" class="btn btn-sm btn-primary me-2">Quick View</a>
											<a href="#" class="btn btn-sm btn-primary-light">Purchase</a>
										</div>
