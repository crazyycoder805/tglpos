...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-17.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:25 GMT -->
<head>
		<meta charset="utf-8">
					...
					<div class="row">
							...
							<div class="row">
								<div class="col-6">
									<div class="box bg-info pull-up">
										<div class="box-body">
											<span class="fs-60 icon-Dollar"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span>
											<h2>$8k <small class="fs-16">B</small></h2>
											<p>Turnover</p>
										</div>
									</div>
								</div>
								<div class="col-6">
									<div class="box bg-success pull-up">
										<div class="box-body">
											<span class="fs-60 icon-Building"><span class="path1"></span><span class="path2"></span><span class="path3"></span></span>
											<h2>79k <small class="fs-16">+</small></h2>
											<p>Clients.</p>
										</div>
									</div>
								</div>
						...
						<div class="col-xxl-6 col-xl-4">
							<div class="box">
								...
								<div class="box-body py-0 pe-10 ps-0">
						  ...
						  <div class="box">
							<div class="box-body">
								<div class="d-flex justify-content-between align-items-center mb-5">
									<h4 class="box-title m-0">Total Sales</h4>
									<ul class="list-inline mb-0">
										<li><span class="badge badge-xl badge-dot badge-success me-10"></span>Online</li>
										<li><span class="badge badge-xl badge-dot badge-danger me-10"></span>Offline</li>
									</ul>
									<div>
										<a href="javascript:void()" class="btn btn-primary btn-xs">View Details</a>
									</div>
								</div>
							</div>
							<div class=" mt-20">
						  ...
						  <div class="box">
							<div class="box-body border-bottom">
								<div class="d-flex justify-content-between mb-4">
									<h5>Your Walet</h5>
									<h5>This month <span class="text-lgreen ml-2"><i class="fa fa-angle-down me-1"></i>1309</span></h5>
								</div>
								<h1 class="text-primary mb-30">$ <span>45000.00</span></h1>
								<div class="chart my-10">
									<div id="walet-status"></div>
								</div>
							</div>				
							<div class="box-body mb-0 pb-0">
								<div class="row py-2 m-0">
									<div class="col-lg-6 pl-xl-0">
										<h2 class="text-primary m-0">$ <span>850</span></h2>
										<p class="m-0">Expenses</p>
										<div class="progress mt-4">
											<div class="progress-bar progress-bar-primary progress-bar-striped" style="width: 60%;" role="progressbar"><span class="sr-only">60% Complete</span>
											</div>
										</div>
									</div>
									<div class="col-lg-6 pr-xl-0">
										...
										<div class="progress mt-4">
											<div class="progress-bar progress-bar-danger progress-bar-striped" style="width: 60%;" role="progressbar"><span class="sr-only">60% Complete</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="box-body">
									<div class="d-flex align-items-center mb-30">
										...
										<div class="d-flex flex-column flex-grow-1 me-2 fw-500">
											...
											<span class="text-fade">Pharetra, Nulla , Nec</span>
										</div>
										<span class="badge badge-xl badge-danger-light"><span class="fw-600">+125$</span></span>
									</div>
									<div class="d-flex align-items-center mb-30">
										<div class="me-15 bg-lightest h-50 w-50 l-h-50 rounded text-center">
									...
									<div class="d-flex align-items-center mb-30">
										...
										<span class="badge badge-xl badge-success-light"><span class="fw-600">+125$</span></span>
									</div>
									<div class="d-flex align-items-center mb-30">
										<div class="me-15 bg-lightest h-50 w-50 l-h-50 rounded text-center">
											  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/004-dad.svg" class="h-30" alt="">
										</div>
										<div class="d-flex flex-column flex-grow-1 me-2 fw-500">
											<a href="#" class="text-dark hover-info mb-1 fs-16">Phasellus venenatis</a>
											<span class="text-fade">Pharetra, Nulla , Nec</span>
										</div>
										<span class="badge badge-xl badge-info-light"><span class="fw-600">+125$</span></span>
									</div>
									<div class="d-flex align-items-center">
										...
										<span class="badge badge-xl badge-warning-light"><span class="fw-600">+125$</span></span>
									</div>
								</div>
							</div>
						</div>
						<div class="col-12 col-xxl-4 col-xl-6">
							<div class="box">
								<div class="box-body">	
									<div class="d-flex flex-wrap align-items-center">							
										<div class="me-10 bg-warning-light h-80 w-80 l-h-80 rounded text-center">
											  <img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/003-settings.svg" class="h-50 align-self-center" alt="">
										</div>

										<div class="d-flex flex-column flex-grow-1 my-lg-0 my-10">
											<a href="#" class="text-dark fw-600 hover-warning fs-16">
										...
										<div class="d-flex flex-column w-p100 mt-20">
							...
							<a href="#" class="box bg-warning bg-hover-warning pull-up">
								<div class="box-body">
									...
									<div class="text-white fs-16">70% Up for 2024</div>
								</div>
							</a>
						</div>
						<div class="col-12 col-xxl-4">
							<div class="box bg-img box-inverse pull-up" style="background-image: url(../../../images/gallery/thumb/14.jpg);" data-overlay="5">				
							...
							<div class="box box-inverse box-info pull-up">
								<div class="box-body">
								  ...
								  <div>
									...
									<blockquote class="blockquote mx-5 mt-20 fs-16 text-white">Vivamus condimentum erat non turpis placerat, at volutpat.</blockquote>
								  </div>
								</div>
							</div>
						</div>
										...
										<table class="table no-border table-vertical-center">
											<thead>
												<tr>
													...
													<th class="p-0" style="min-width: 210px"></th>
						...
						<div class="col-12 col-xxl-4 col-lg-8">
							<div class="box">		
								...
								<div class="box-body up-mar40 bg-white position-relative pb-5">	
									<div class="row">
										<div class="col-6">
											<div class="px-30 py-20">
												<div class="text-fade fw-600">Average</div>
										...
										<div class="col-6">
											<div class="px-30 py-20">
												<div class="text-fade fw-600">Income</div>
						...
						<div class="col-12 col-xxl-2 col-lg-4">
							<a class="box box-link-shadow text-center pull-up" href="javascript:void(0)">
								<div class="box-body py-20 bg-info-light">
							...
							<a class="box box-link-pop text-center pull-up" href="javascript:void(0)">
								<div class="box-body">
									<p class="fs-40 text-danger">
										<strong>987€</strong>
									</p>
								</div>
								<div class="box-body py-20 bg-danger-light">
									<p class="fw-600">
							...
							<a href="#" class="box bg-primary bg-hover-primary pull-up">
								<div class="box-body text-center">
									...
									<div class="text-white fw-600 fs-18 mt-5">Shopping Cart</div>
								</div>
							</a>
						</div>
					</div>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard17.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-17.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:26 GMT -->
</html>
