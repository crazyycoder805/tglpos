...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/box_group.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:34 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Group Box </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Group Box</h4>
		...
		<section class="content">
				...
				<div class="row row-cols-1 row-cols-lg-3 g-4">
					<div class="col">
						<div class="card h-p100">
							...
							<div class="card-body">
							  <h4 class="card-title fw-500 b-0 px-0">Card title</h4>
							  <p class="text-gray-600">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
							</div>
				...
				<div class="card bg-primary-light">
				  <div class="card-header">
					<h4 class="card-title">Group
						<span class="subtitle fs-14 mb-0">Use card groups to render cards as a single, attached element with equal width and height columns.</span>
					</h4>
				  </div>
				</div>
			  </div>
			...
			<div class="col-12">
			  ...
			  <div class="col-12">	
				<div class="card bg-primary-light">
				  <div class="card-header">
					<h4 class="card-title fw-500">Columns
						<span class="subtitle fs-14 mb-0">ards can be organized into Masonry-like columns with just CSS by wrapping them in <code>.card-columns</code>. cards are ordered from top to bottom and left to right when wrapped in <code>.card-columns</code>.</span>
					</h4>
				  </div>
				</div>
			  </div>	
			...
			<div class="col-12">
				<div class="card-columns">
				  <div class="card">
					...
					<div class="card-body">
					  <h4 class="card-title fw-500 b-0 px-0">card title that wraps to a new line, but not in the large screens</h4>
					  <p class="text-gray-600">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
					</div>
					  <div class="card-footer justify-content-between d-flex">
						<span class="text-muted">Last updated 3 mins ago</span>
					...
					<img class="card-img" src="../../../images/gallery/thumb/9.jpg" alt="card image">
					  <div class="card-footer">
						<div class="input-group">
							...
							<button class="btn bg-primary btn-sm" type="button"><i class="fa fa-send-o"></i></button>
						</div>
					  </div>
				  </div>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/box_group.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
</html>
