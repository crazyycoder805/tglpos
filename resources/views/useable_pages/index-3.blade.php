...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:05 GMT -->
<head>
		<meta charset="utf-8">
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<button type="button" class="waves-effect waves-light btn btn-rounded btn-dark mb-5"><i class="fa fa-fw fa-apple"></i> Apple.Inc</button>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">AAPL</a>
									...
									<div class="row align-items-center mt-10">
										<div class="col-6">
											<p class="text-muted fw-normal m-0 text-muted" title="Protfolio">Protfolio</p>
											<h3 class="m-0 fw-600">15,215.70</h3>
										</div>
										<div class="col-6">
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box mb-15 pull-up hover-success">
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<button type="button" class="waves-effect waves-light btn btn-rounded btn-danger mb-5"><i class="fa fa-bolt" aria-hidden="true"></i> Nasdaq.Inc</button>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">NDAQ</a>
									...
									<div class="row align-items-center mt-10">
										<div class="col-6">
											<p class="text-muted fw-normal m-0 text-muted" title="Protfolio">Protfolio</p>
											<h3 class="m-0 fw-600">15,120.20</h3>
										</div>
										<div class="col-6">
											<div class="text-end" style="position: relative;">
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box mb-15 pull-up hover-success">
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<button type="button" class="waves-effect waves-light btn btn-rounded btn-info mb-5"><i class="fa fa-fw fa-angellist"></i> Tesla.Inc</button>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">TSLA</a>
									...
									<div class="row align-items-center mt-10">
										<div class="col-6">
											<p class="text-muted fw-normal m-0 text-muted" title="Protfolio">Protfolio</p>
											<h3 class="m-0 fw-600">10,225.40</h3>
										</div>
										<div class="col-6">
											<div class="text-end" style="position: relative;">
												<div id="new-leads-chart3" style="min-height: 70px;"></div>
											</div>
										</div> <!-- end row-->
									</div>
								</div>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box mb-15 pull-up hover-success">
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<button type="button" class="waves-effect waves-light btn btn-rounded btn-warning mb-5"><i class="fa fa-fw fa-amazon"></i> amazon.Inc</button>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">AMZN</a>
									...
									<div class="row align-items-center mt-10">
										<div class="col-6">
											<p class="text-muted fw-normal m-0 text-muted" title="Protfolio">Protfolio</p>
											<h3 class="m-0 fw-600">40,500.20</h3>
										</div>
										<div class="col-6">
											<div class="text-end" style="position: relative;">
												<div id="new-leads-chart4" style="min-height: 70px;"></div>
											</div>
										</div> <!-- end row-->
									</div>
								</div>
						...
						<div class="col-xxl-8 col-12">
							<div class="box">
								<div class="box-body pb-lg-0">
									<div class="row">
										<div class="col-lg-4 col-12 be-1">
									...
									<div class="row mt-30">
										...
										<div class="col-lg-5 col-12">
											...
											<div class="d-flex justify-content-start align-items-center mt-md-20 mt-0">
												...
												<ul class="list-unstyled text-overflow w-150" style="margin-left: -21px;">
													<li class="text-overflow"><span class="badge badge-primary badge-dot me-10"></span> Large Cap Funds</li>
													<li class="text-overflow"><span class="badge badge-info badge-dot me-10"></span> Diversified Funds</li>
													<li class="text-overflow"><span class="badge badge-success badge-dot me-10"></span> Debt Funds</li>
												</ul>
											</div>
										</div>
									</div>
								...
								<div class="box-body">
									<div class="d-md-flex justify-content-between align-items-center">
										...
										<div class="mt-10 mt-md-0">
											<a href="invest.html" class="waves-effect waves-light btn btn-outline btn-danger">Invest Now</a>
										</div>
									</div>
									<hr>
									<div class="d-md-flex justify-content-between align-items-center">								
							...
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-md-flex justify-content-between align-items-center">
										<div>
											<p><span class="text-primary">Debt</span> | <span class="text-fade">Consumption</span></p>
							...
							<div class="row">
										...
										<div class="box-body p-0">
									  		<div class="media-list media-list-hover media-list-divided">
												<a class="media media-single" href="#">
										  			<span class="title text-mute">Previous Close </span>
										  			<span>4,500.50</span>
												</a>

												<a class="media media-single" href="#">
												  <span class="title text-mute">Dry Range</span>
												  <span>3,588-5,415</span>
												</a>

												<a class="media media-single" href="#">
												  <span class="title text-mute">Year Range</span>
												  <span>6,200-4,500</span>
												</a>

												<a class="media media-single" href="#">
												  <span class="title text-mute">Market Cap</span>
												  <span>$90.3T USD</span>
												</a>

												<a class="media media-single" href="#">
												  <span class="title text-mute">Volume</span>
												  <span>3,852,852</span>
												</a>

												<a class="media media-single" href="#">
												  <span class="title text-mute">PVE Ratio</span>
												  <span>51.05</span>
												</a>
									  		</div>
								   		</div>
								...
								<div class="col-lg-12">
									<div class="box">
										<div class="box-body">
											<div class="row">
												<div class="col-xxl-12 col-lg-6 investment">
													...
													<table class="table">
														<tbody>
															<tr>
																...
																<td class="text-end text-success">+23.36%</td>
															</tr>
															<tr>
																<td>
																	<div class="progress progress-lg">
																...
																<td class="text-end text-success">+48.51%</td>
															</tr>
															<tr>
																<td>
																	<div class="progress progress-lg">
																...
																<td class="text-end text-success">+95.82%</td>
															</tr>
															<tr>
																<td>
																	<div class="progress progress-lg">
																...
																<td class="text-end text-success">+162.90%</td>
															</tr>
															<tr>
																<td>
																	<div class="progress progress-lg">
																...
																<td class="text-end text-success">+327.123%</td>
															</tr>
														</tbody>
													</table>
												</div>
												<div class="col-xxl-12 col-lg-6 meter">
													<h3>Scheme Riskometer</h3>
													<div id="chart-container"></div>
													<p class="text-fade">Investors understand that their principal will beat <span class="text-danger">very high</span> risk</p>
												</div>
											</div>
										</div>
									</div>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard3.js"></script>
