...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/email_verify_email_dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:51:01 GMT -->
<head>
<title></title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
					<td bgcolor="#293146" align="center" valign="top" style="padding: 40px 20px 10px 20px; border-radius: 4px 4px 0px 0px;">
                      <h1 style="color: #ffffff; font-size: 29px; font-weight: 400; margin: 0; font-family: 'Poppins', sans-serif;">Hi! Jhone</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
