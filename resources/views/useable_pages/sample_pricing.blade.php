...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/sample_pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:50:00 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Pricing tables </title>
		...
		<section class="content">
			<div class="row mt-50">
				<div class="col-lg-4">
					<div class="card card-pricing">
						<div class="card-body text-center">
							<h4 class="card-pricing-plan-name fw-500 text-uppercase">Professional Pack</h4>
							...
							<ul class="card-pricing-features">
								<li><i class="me-5 text-success fa fa-check"></i>10 GB Storage</li>
								<li><i class="me-5 text-success fa fa-check"></i>500 GB Bandwidth</li>
								<li><i class="me-5 text-gray fa fa-close"></i>No Domain</li>
								<li><i class="me-5 text-gray fa fa-close"></i>1 User</li>
								<li><i class="me-5 text-gray fa fa-close"></i>Email Support</li>
								<li><i class="me-5 text-gray fa fa-close"></i>24x7 Support</li>
							</ul>
							<button class="btn btn-primary mt-4">Choose Plan</button>
						</div>
				...
				<div class="col-lg-4">
					<div class="card card-pricing card-pricing-recommended">
						<div class="card-body text-center">
							...
							<h4 class="card-pricing-plan-name fw-500 text-uppercase">Business Pack</h4>
							<i class="card-pricing-icon fa fa-briefcase text-primary bg-primary-light"></i>
							<h2 class="card-pricing-price">$29 <span>/ Month</span></h2>
							<ul class="card-pricing-features">
								<li><i class="me-5 text-success fa fa-check"></i>50 GB Storage</li>
								<li><i class="me-5 text-success fa fa-check"></i>900 GB Bandwidth</li>
								<li><i class="me-5 text-success fa fa-check"></i>2 Domain</li>
								<li><i class="me-5 text-success fa fa-check"></i>10 User</li>
								<li><i class="me-5 text-gray fa fa-close"></i>Email Support</li>
								<li><i class="me-5 text-gray fa fa-close"></i>24x7 Support</li>
							</ul>
							<button class="btn btn-primary mt-4">Choose Plan</button>
				...
				<div class="col-lg-4">
					<div class="card card-pricing">
						<div class="card-body text-center">
							<h4 class="card-pricing-plan-name fw-500 text-uppercase">Enterprise Pack</h4>
							<i class="card-pricing-icon fa fa-shopping-bag text-primary bg-primary-light"></i>
							<h2 class="card-pricing-price">$39 <span>/ Month</span></h2>
							<ul class="card-pricing-features">
								<li><i class="me-5 text-success fa fa-check"></i>100 GB Storege</li>
								<li><i class="me-5 text-success fa fa-check"></i>Unlimited Bandwidth</li>
								<li><i class="me-5 text-success fa fa-check"></i>10 Domain</li>
								<li><i class="me-5 text-success fa fa-check"></i>Unlimited User</li>
