...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_portlet_draggable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:50 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Draggable Portlets </title>
			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-body">
					...
					<p class="text-fade">Thus is a widget layout jquery plugin.
					<a href="http://troolee.github.io/gridstack.js/" target="_blank" class="text-primary">gridstack.js</a> is used to design this layout. This is drag-and-drop multi-column grid. It allows you to build draggable responsive layouts.</p>
				</div>
				<!-- /.box-body -->
			  </div>
			  <!-- /.box -->
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_portlet_draggable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:52 GMT -->
</html>
