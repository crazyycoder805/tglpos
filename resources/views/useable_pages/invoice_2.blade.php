...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/invoice_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:42 GMT -->
<head>
  <meta charset="utf-8">
							...
							<div class="row">
									...
									<div>
										<div class="mt-1">
											<div class="d-flex pb-30 justify-content-between align-items-center">
												<img alt="Logo" src="../../../images/logo-light-text3.png" class="d-light">
												<img alt="Logo" src="../../../images/logo-light-text4.png" class="d-dark">
												<a href="#" class="btn btn-primary-light">Pay Now</a>
											</div>
											<div class="m-0">
								...
								<div class="col-lg-3 col-12 mt-30 mt-lg-0">
									<div class="border border-dashed border-gray-300 card-rounded h-lg-p100 min-w-md-350 p-30 bg-gray-100 invoice-data">
										...
										<div class="mb-30">
											<div class="fw-600 text-gray-600 fs-14"><img src="../../../images/paypal.png" class="mb-5 max-w-100" alt="" /></div>
