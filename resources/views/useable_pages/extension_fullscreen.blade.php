...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/extension_fullscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:48 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Extension Fullscreen </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Fullscreen</h4>
		...
		<section class="content">
		  ...
		  <div class="box">
			...
			<div class="box-body">
				<p class="text-fade">Simple wrapper for RubyX-browser usage of the JavaScript Fullscreen API, which lets you bring the page into fullscreen.<a href="https://github.com/sindresorhus/screenfull.js/" target="_blank" class="pull-right">Official documentation</a></p>
				<h5 class="text-fade">Examples</h5>
				  <div class="gap-items gap-y">
					<button class="btn btn-info-light ms-1" id="request">Request</button>
					<button class="btn btn-danger-light ms-1" id="exit">Exit</button>
					<button class="btn btn-success-light ms-1" id="toggle">Toggle</button>
					<button class="btn btn-warning-light ms-1" id="request2">Request document</button>
					<button type="button" class="btn btn-primary-light" data-provide="fullscreen">
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/fullscreen.js"></script>

</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/extension_fullscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:49 GMT -->
</html>
