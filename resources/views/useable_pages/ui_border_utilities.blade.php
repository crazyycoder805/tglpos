...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_border_utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Border Class Utilities </title>
			  ...
			  <div class="row">
				<div class="col-12">					
					...
					<div class="d-flex flex-row mb-3">
					  ...
					  <div class="px-25 py-15 text-fade">border-top: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.bb-1</code></div>
					  <div class="px-25 py-15 text-fade">border-bottom: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.bs-1</code></div>
					  <div class="px-25 py-15 text-fade">border-left: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.be-1</code></div>
					  <div class="px-25 py-15 text-fade">border-right: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.bx-1</code></div>
					  <div class="px-25 py-15 text-fade">border-left: 1px solid ...<br>border-right: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.by-1</code></div>
					  <div class="px-25 py-15 text-fade">border-top: 1px solid ...<br>border-bottom: 1px solid ...</div>
					</div>
										
					<div class="d-flex flex-row mb-3">
					  <div class="px-25 py-15 w-200"><code>.b-1</code></div>
					  <div class="px-25 py-15 text-fade">border: 1px solid ...</div>
					</div>						
				</div>

				<div class="col-12">
					<p class="text-fade">You can add solid borders to an element using following classes. You're able to change the border color using <a href="https://bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/content/utilities-color.html">border color utility classes</a>.</p>
					<p class="text-fade">The classes follows b{side}-{size} format, where <code>{size}</code> is one of <code>0</code>, <code>1</code>, <code>2</code>, <code>3</code>, <code>4</code>, or <code>5</code> values. Also, <code>{side}</code> is one of:</p>
					<ul class="text-fade">
