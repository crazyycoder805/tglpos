...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_dropdown.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
<head>
  <meta charset="utf-8">
	  ...
	  <div class="container-full">
		...
		<section class="content">
			...
			<div class="row">
				<div class="col-12">
					<div class="box">
					  <div class="box-header bg-primary-light no-border">
						  <h4 class="box-title">Dropdown Basic</h4>
						   <span class="text-muted d-block">Dropdowns are toggleable, contextual overlays for displaying lists of links and more.</span>
					  </div>
					</div>	
					<div class="row">
					  <!--Default!-->
					  <div class="col-xl-4">
						  <div class="box">
							  <div class="box-body">
								  <div>
									<h5>Default</h5>
									<p class="text-fade">A basic example</p>
									<div class="btn-group">
					  ...
					  <div class="col-xl-4">
						  <div class="box">
							  <div class="box-body">
								  <div>
									<h5>Alignment</h5>
									<p class="text-fade"><code>.dropdown-menu-end</code> applies to <em>.dropdown-menu</em></p>
										<div class="btn-group">
										  <button class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
					  ...
					  <div class="col-xl-4">
						  <div class="box">
							  <div class="box-body">
								  <div>
									<h5>Dropup</h5>
									<p class="text-fade"><code>.dropup</code> replaces with <em>.dropdown</em></p>
										<div class="btn-group dropup">
										  <button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropup</button>
										  <div class="dropdown-menu">
											<a class="dropdown-item" href="#">Action</a>
											<a class="dropdown-item" href="#">Another action</a>
											<a class="dropdown-item" href="#">Something else here</a>
					  ...
					  <div class="col-xl-4">
						  <div class="box">
							  <div class="box-body">
								  <div>
									<h5>No caret</h5>
									<p class="text-fade"><code>.no-caret</code> applies to <em>.dropdown-toggle</em></p>
									<div class="btn-group">
									  <button class="btn btn-warning dropdown-toggle no-caret" type="button" data-bs-toggle="dropdown">Dropdown</button>
									  <div class="dropdown-menu">
										<a class="dropdown-item" href="#">Action</a>
										<a class="dropdown-item" href="#">Another action</a>
										<a class="dropdown-item" href="#">Something else here</a>
					  ...
					  <div class="col-xl-4">
						  <div class="box">
							  <div class="box-body">
								  <div>
									<h5>With icon</h5>
									<p class="text-fade"><code>.icon</code> applies to <em>.dropdown-toggle</em></p>
									<div class="btn-group">
									  <button class="btn btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown"><i class="icon ti-settings"></i> Dropdown</button>
									  <div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item" href="#">Action</a>
										<a class="dropdown-item" href="#">Another action</a>
										<a class="dropdown-item" href="#">Something else here</a>
				...
				<div class="col-12">				
					<div class="box">
					  <div class="box-header bg-primary-light with-border">
						  <h4 class="box-title">Dropdown menu</h4>
						   <span class="text-muted d-block">Dropdowns are toggleable, contextual overlays for displaying lists of links and more.</span>
					  </div>
					</div>
					<div class="row">
							  ...
							  <div class="box">
								  <div class="box-body">
									  <div>
										<h5>Header</h5>
										  <div class="dropdown">
											<button class="btn btn-outline btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
								  ...
								  <div class="box-body">
									  <div>
										<h5>Divider</h5>
										  ...
										  <div class="dropdown">
											<button class="btn btn-outline btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
											  <a class="dropdown-item" href="#">Action</a>
											  <a class="dropdown-item" href="#">Another action</a>
											  <a class="dropdown-item" href="#">Something else here</a>
								  ...
								  <div class="box-body">
									  <div>
										<h5>With icon</h5>
										  ...
										  <div class="dropdown">
											<button class="btn btn-outline btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
						  ...
						  <div class="col-xl-4">
							  <div class="box">
								  <div class="box-body">
									  <div>
										<h5>Disabled item</h5>
										<p class="text-fade"><code>.disabled</code> applies to <em>.dropdown-item</em></p>

										  <div class="dropdown">
											<button class="btn btn-outline btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
											<div class="dropdown-menu">
											  <a class="dropdown-item" href="#">Action</a>
						  ...
						  <div class="col-xl-4">
							  <div class="box">
								  <div class="box-body">
									  <div>
										<h5>Active item</h5>
										<p class="text-fade"><code>.active</code> applies to <em>.dropdown-item</em></p>
