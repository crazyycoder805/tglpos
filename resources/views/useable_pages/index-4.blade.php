...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:05 GMT -->
<head>
		<meta charset="utf-8">
		...
		<title>Bsinx Admin - Dashboard</title>
		...
		<div class="content-wrapper">
			<div class="container-full">
				...
				<section class="content">			
					<div class="row">
						<div class="col-xl-8">
							<div class="box bg-black b-1">
								<div>
									<div class="box-body flex-grow-1 p-30 flex-grow-1 fs-30 bg-none-md" style="background-position: right bottom; background-size: auto 100%; background-image: url(../../../images/big-bg.jpg);direction: ltr;text-align: left;">
										<h1 class="fw-700 mt-0 text-white">Discover, Buy, and Sell Digital<br>Assets in The World</h1>
										<p class="text-lighter my-20 fs-16">All type blockchain in the world already here, everyone can<br>buy and sell the digital assets.</p>
						...
						<div class="col-xl-4">
							<div class="box overflow-hidden b-1">
								<div>
									<div class="box-body pb-0 d-flex align-items-center justify-content-between">
										...
										<h3 class="m-0">$12,458.58</h3>
									</div>
									<div id="chart-widget1"></div>
									<div class="box-body pt-0 d-flex align-items-center justify-content-between">
										<div>
											<h3 class="m-0 fw-500">Main Stocks</h3>
											<p class="m-0">Extended & Limited</p>
										</div>
										<div><span class="badge badge-pill badge-primary">+7.5%</span></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-xxl-3 col-xl-3  col-lg-6 col-12">
							<div class="box box-body p-15 pull-up b-1">
							  	<div class="d-flex align-items-center p-0">
									<div class="text-center align-content-center rounded-3 bg-warning-light h-80 w-80 me-15">
									  	<i class="cc BTC-alt text-warning m-0" title="BTC"></i>
									</div>
									<div class="d-flex flex-column">
								  		<h5 class="mt-0 text-fade ">Bitcoin </h5>
									  	<h3 class="m-0 fw-500">$52,742.40</h3>
									</div>
							  	</div>
							</div>
						</div>
						<div class="col-xxl-3 col-xl-3 col-lg-6 col-12">					
							<div class="box box-body p-15 pull-up b-1">
							  	<div class="d-flex align-items-center p-0">
									<div class="text-center align-content-center rounded-3 bg-info-light h-80 w-80 me-15">
									  	<i class="cc LTC-alt text-info m-0" title="LTC"></i>
									</div>
									<div class="d-flex flex-column">
									  	<h5 class="mt-0 text-fade ">Litecoin</h5>
									  	<h3 class="m-0 fw-500">$53.50</h3>
									</div>
							  	</div>
							</div>		
						</div>
						<div class="col-xxl-3 col-xl-3 col-lg-6 col-12">			
							<div class="box box-body p-15 pull-up b-1">
							  <div class="d-flex align-items-center p-0">
									<div class="text-center align-content-center rounded-3 bg-success-light h-80 w-80 me-15">
								  		<i class="cc ETH-alt text-success m-0" title="NEO"></i>
									</div>
									<div class="d-flex flex-column">
								  		<h5 class="mt-0 text-fade ">Etherum</h5>
								  		<h3 class="m-0 fw-500">$2,327.16</h3>
									</div>
							  	</div>
							</div>
						</div>		
						<div class="col-xxl-3 col-xl-3 col-lg-6 col-12">
							<div class="box box-body p-15 pull-up b-1">
								<div class="d-flex align-items-center p-0 ">
									<div class="text-center align-content-center rounded-3 bg-primary-light h-80 w-80 me-15">
									  <i class="cc DASH-alt text-primary m-0" title="DASH"></i>
									</div>
									<div class="d-flex flex-column">
								  		<h5 class="mt-0 text-fade ">Dash</h5>
								  		<h3 class="m-0 fw-500">$20.59</h3>
									</div>
								</div>
							</div>
						</div>
						<div class="col-12">
							<div class="box overflow-hidden b-1">
								<div class="box-header with-border">
								  <h4 class="box-title">Crypto Live</h4>
								</div>
							...
							<div class="box"> 
								<div class="box-header b-0">
									<div class="d-lg-flex justify-content-between align-items-center">
										<div>
											<h4 class="mb-5">Recent Activities</h4>
										</div>
										<div class="d-sm-flex">
											<div class="btn-group mb-5">
											  <button class="btn rounded-4 btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown">Last 30 Days </button>
											  <div class="dropdown-menu">
											...
											<div class="btn-group mb-5 ms-10">
											  <button class="btn rounded-4 btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown">Jun 2024 </button>
											  <div class="dropdown-menu">
												<a class="dropdown-item" href="#">Action</a>
												<a class="dropdown-item" href="#">Another action</a>
												<a class="dropdown-item" href="#">Something else here</a>
											...
											<div class="btn-group mb-5 ms-10">
												<form class="d-flex" role="search">
											        <input class="form-control me-2 rounded-4 bg-light" type="search" placeholder="Search" aria-label="Search">
											        <button class="btn btn-info rounded-4" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
											    </form>
											</div>
										</div>
									</div>
									...
									<div class="box-body no-padding">
										<div class="table-responsive">
										  <table class="table table-hover mb-0">
											...
											<tr>
											  <td><i class="cc BTC m-0 l-h-48" title="BTC" style="rotate: 10deg;"></i></td>
											  <td>
											  	<div>
											  		<h5 class="m-0">$653.10</h5>
											  		<p class="m-0">Withdraw USDT</p>
											  	</div>
											  </td>
											  <td>#14525156</td>
											  <td><span><i class="fa fa-clock-o"></i> Jun 10, 2024</span> </td>
											  <td><span class="badge badge-pill badge-success">Complited</span></td>
											  <td>7.57321 BTC</td>
											</tr>
											<tr>
											  <td><i class="cc USDT-alt m-0 l-h-40 text-success" title="USDT"></i></td>
											  <td>
											  	<div>
											  		<h5 class="m-0">$542.05</h5>
											  		<p class="m-0">Deposit BTC</p>
											  	</div>
											  </td>
											  <td>#03483195</td>
											  <td><span><i class="fa fa-clock-o"></i> Jun 15, 2024</span> </td>
											  <td><span class="badge badge-pill badge-danger">Declined</span></td>
											  <td>1.23450 BTC</td>
											</tr>
											<tr>
											  <td><i class="cc ARK-alt m-0 l-h-40 text-primary" title="ARK"></i></td>
											  <td>
											  	<div>
											  		<h5 class="m-0">$456.10</h5>
											  		<p class="m-0">Deposit BTC</p>
											  	</div>
											  </td>
											  <td>#8520097</td>
											  <td><span><i class="fa fa-clock-o"></i> Jun 18, 2024</span> </td>
											  <td><span class="badge badge-pill badge-warning">Panding</span></td>
											  <td>0.12000 BTC</td>
											</tr>
											<tr>
											  <td><i class="cc JBS-alt m-0 l-h-40 text-danger" title="JBS"></i></td>
											  <td>
											  	<div>
											  		<h5 class="m-0">$759.10</h5>
											  		<p class="m-0">Withdraw USDT</p>
											  	</div>
											  </td>
											  <td>#00078867</td>
											  <td><span><i class="fa fa-clock-o"></i> Jun 20, 2024</span> </td>
											  <td><span class="badge badge-pill badge-success">Complited</span></td>
											  <td>0.49867 BTC</td>
											</tr>
										  </tbody></table>
						...
						<div class="col-xxl-3 col-xl-7 col-lg-6">
							<div class="box">
								<div class="box-header b-0 d-flex justify-content-between align-items-center">
									<div>
										<h4 class="m-0 fw-500">Quick Exchage</h4>								
									</div>
									<div>
										<i class="fa-solid fa-gear fs-18"></i>
										<i class="fa-solid fa-clock-rotate-left fs-18 ms-5"></i>
									</div>
								</div>
								<div class="box-body">
									<div class="box-body bg-light">
										<div class="d-flex justify-content-between align-items-center">
											<p class="m-0">I have :</p>
											<p class="m-0">0.25645 BTC</p>
										</div>
										<div class="d-flex justify-content-between align-items-center">
											<div class="d-flex align-items-center">
												<i class="cc BTC me-10" title="BTC" style="rotate: 10deg;"></i>
												<h4 class="mb-0 mt-1 fw-500">BTC <i class="fa-solid fa-angle-down fs-14"></i></h4>
											</div>
											<p class="m-0 fs-18 fw-500">0.01</p>
										</div>
									</div>
									<div class="text-center" style="display: flex; justify-content: center; margin: -27px 0px;">
										<div class="w-80 h-80 bg-dark rounded-circle align-content-center">
											<i class="fa-solid fa-arrow-right-arrow-left w-40 h-40 bg-success rounded-circle align-content-center"></i>
										</div>
									</div>
									<div class="box-body bg-light">
										<div class="d-flex justify-content-between align-items-center">
											<p class="m-0">I have :</p>
											<p class="m-0">12000 USDT</p>
										</div>
										<div class="d-flex justify-content-between align-items-center">
											<div class="d-flex align-items-center">
												<i class="cc USDT-alt me-10 text-success" title="TX"></i>
												<h4 class="mb-0 mt-1 fw-500">USDT <i class="fa-solid fa-angle-down fs-14"></i></h4>
											</div>
											<p class="m-0 fs-18 fw-500">$408</p>
										</div>
									</div>
									<div class="mt-20">
										<button class="btn btn-success btn-lg w-p100">Exchage <i class="fa-solid fa-arrow-right w-30 h-30 bg-success-light rounded align-content-center float-end"></i></button>
									</div>
								</div>
							</div>
						</div>
						<div class="col-xxl-12 col-xl-5 col-lg-6">
							<div class="row">
								<div class="col-xxl-3 col-lg-12">
								  	<div class="box pull-up mb-30">
								  		<div class="box-body d-flex align-items-center justify-content-between">				  
											<div class="media align-items-center p-0">
												<div class="text-center m-0">
												 <i class="cc BTC w-50 h-50 border border-warning m-0 rounded-circle l-h-42 " title="BTC" style="rotate: 10deg;"></i>
												</div>
												<div>
												  <h4 class="m-0 fw-500">Bitcoin</h4>
												  <span class="text-fade">BTC</span>
												</div>
											</div>
											<div>
												<div class="btn-group">
												  	<button class="waves-effect waves-light btn btn-outline btn-dark rounded-4 btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">24h </button>
												</div>
											</div>
									  	</div>
								  	</div>
								...
								<div class="col-xxl-3 col-lg-12">
								  	<div class="box pull-up mb-30">
								  		<div class="box-body d-flex align-items-center justify-content-between">				  
											<div class="media align-items-center p-0">
												<div class="text-center m-0">
												 <i class="cc USDT-alt w-50 h-50 border border-success m-0 rounded-circle l-h-42 text-success" title="TX"></i>
												</div>
												<div>
												  <h4 class="m-0 fw-500">Theter</h4>
												  <span class="text-fade">USDT</span>
												</div>
											</div>
											<div>
												<div class="btn-group">
								...
								<div class="col-xxl-3 col-lg-12">
								  	<div class="box pull-up mb-25">
								  		<div class="box-body d-flex align-items-center justify-content-between">				  
											<div class="media align-items-center p-0">
												<div class="text-center m-0">
												 <i class="cc ARK-alt w-50 h-50 border border-primary m-0 rounded-circle l-h-42 text-primary" title="ARK"></i>
												</div>
												<div>
												  <h4 class="m-0 fw-500">ARK</h4>
												  <span class="text-fade">BTC</span>
												</div>
											</div>
											<div>
								...
								<div class="col-xxl-3 col-lg-12">
								  	<div class="box pull-up">
								  		<div class="box-body d-flex align-items-center justify-content-between">				  
											<div class="media align-items-center p-0">
												<div class="text-center m-0">
												 <i class="cc JBS-alt w-50 h-50 border border-danger m-0 rounded-circle l-h-42 text-danger" title="JBS" style="rotate: 10deg;"></i>
												</div>
												<div>
												  <h4 class="m-0 fw-500">JBS</h4>
												  <span class="text-fade">BTC</span>
												</div>
											</div>
											<div>
...
<!-- ./wrapper -->
	...
	<script src="../../../assets/vendor_components/zingchart_branded_version/zingchart.min.js"></script>
	...
	<script src="../../../../../fastly.jsdelivr.net/npm/echarts%405/dist/echarts.min.js"></script>

	
	<!-- Bsinx Admin App -->
	<script src="../src/js/demo.js"></script>
	<script src="../src/js/template.js"></script>
	<script src="../src/js/pages/dashboard4.js"></script>

	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:06 GMT -->
</html>
