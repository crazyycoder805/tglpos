...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_date_paginator.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:45 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Date Paginator </title>
			...
			<div class="col-12">
			  <div class="box">
				<div class="box-body res-tb-block">
				  ...
				  <p class="text-fade">A jQuery plugin which takes Twitter Bootstrap's already great pagination component and injects a bit of date based magic. In the process creating a hugely simplified and modularised way of paging date based results in your application.</p>
				</div>
				<!-- /.box -->
			  </div>
			</div>
...
<!-- ./wrapper -->
    ...
    <script src="../../../assets/icons/feather-icons/feather.min.js"></script>	<script src="../../../assets/vendor_components/date-paginator/moment.min.js"></script>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_date_paginator.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:47 GMT -->
</html>
