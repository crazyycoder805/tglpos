...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_dropdown_grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Dropdown Grid </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Dropdown Grid</h4>
			...
			<div class="row">
			  ...
			  <div class="col-xl-4 col-12">
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  <button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
						  <div class="dropdown-menu dropdown-grid">
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/compact_camera.svg" alt="compact_camera.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/stack_of_photos.svg" alt="stack_of_photos.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/folder.svg" alt="folder.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/start.svg" alt="start.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/music.svg" alt="music.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/news.svg" alt="news.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/contacts.svg" alt="contacts.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/download.svg" alt="download.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/settings.svg" alt="settings.svg"/>
							</a>
						  </div>
						</div>
					</div>
			  ...
			  <div class="col-xl-4 col-12">
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  <button class="btn btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
						  <div class="dropdown-menu dropdown-grid">
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/compact_camera.svg" alt="compact_camera.svg"/>
							  <span class="title">Camera</span>
			  ...
			  <div class="col-xl-4 col-12">
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  <button class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
			  ...
			  <div class="col-xl-4 col-12">
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  <button class="btn btn-danger dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
						  <div class="dropdown-menu dropdown-grid cols-4">
							...
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/phone.svg" alt="phone.svg"/>
							...
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/calculator.svg" alt="calculator.svg"/>	
							  <span class="title">Calculator</span>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/alarm_clock.svg" alt="alarm_clock.svg"/>	
			  ...
			  <div class="col-xl-4 col-12">
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  <button class="btn btn-outline btn-info dropdown-toggle" type="button" data-bs-toggle="dropdown">Dropdown</button>
						  <div class="dropdown-menu dropdown-grid">
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/assets/vendor_components/flat-color-icons/SVG/compact_camera.svg" alt="compact_camera.svg"/>	
							  <span class="title">Camera</span>
