...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/mailbox-read.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:51:00 GMT -->
<head>
  <meta charset="utf-8">
							...
							<div class="page-aside-right">
								...
								<div class="mt-30">
									...
									<div class="d-flex mb-3 mt-1">
										<img class="d-flex me-2 rounded-circle" src="../../../images/avatar/1.jpg" alt="placeholder image" height="32">
										<div class="w-p100 overflow-hidden">
											<small class="float-end">Dec 14, 2021, 5:17 AM</small>
									...
									<ol>
										<li>Pellentesque vitae tortor tempus, facilisis arcu id, bibendum nisi.</li>
										<li>Nunc ultrices lacus mollis arcu lobortis, et lacinia dolor tempor.</li>
										<li>Donec et eros placerat lacus varius elementum.</li>
										<li>Sed semper tellus nec ligula varius, vitae consequat mi scelerisque.</li>
										<li>Proin ac mauris sodales, pulvinar eros eget, viverra lacus.</li>
									</ol>

									<p>FDonec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi.</p>
									<p><b>Thanks,</b> <br/> Jane</p>
									<hr/>
											...
											<div class="card mb-1 shadow-none border">
												<div class="p-2">
													<div class="row align-items-center">
														...
														<div class="col ps-0">
															<a href="javascript:void(0);" class="text-muted fw-500">design.zip</a>
															<p class="mb-0">2.3 MB</p>
														</div>
														<div class="col-auto">
															<!-- Button -->
															<a href="javascript:void(0);" class="p-10 fs-18 link">
											...
											<div class="card mb-1 shadow-none border">
												<div class="p-2">
													<div class="row align-items-center">
														...
														<div class="col ps-0">
															<a href="javascript:void(0);" class="text-muted fw-500">Design.jpg</a>
											...
											<div class="card mb-0 shadow-none border">
												<div class="p-2">
													<div class="row align-items-center">
														...
														<div class="col ps-0">
															<a href="javascript:void(0);" class="text-muted fw-500">Report.mp4</a>
									...
									<div class="mt-30">
										<a href="#" class="btn btn-primary me-2"><i class="mdi mdi-reply me-1"></i> Reply</a>
										<a href="#" class="btn btn-info-light">Forward <i class="mdi mdi-forward ms-1"></i></a>
									</div>
