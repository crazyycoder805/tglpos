...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-13.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:18 GMT -->
<head>
		<meta charset="utf-8">
							...
							<div class="box dash-chat" id="chat-bx">
								<div class="box-body p-0">
									<ul class="nav nav-tabs customtab nav-justified" role="tablist">
										<li class="nav-item be-1"> <a class="nav-link active py-20" data-bs-toggle="tab" href="#messages" role="tab">Chats <span class="badge badge-light badge-pill mx-5">32</span> </a> </li>
										<li class="nav-item"> <a class="nav-link py-20" data-bs-toggle="tab" href="#contacts" role="tab">Archived <span class="badge badge-light badge-pill mx-5">08</span></a> </li>
									</ul>
									<!-- Tab panes -->
											...
											<div class="chat-box-six2">
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-success avatar avatar-lg" href="#"><img class="bg-primary-light" src="../../../images/avatar/avatar-1.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-danger avatar avatar-lg" href="#"><img class="bg-success-light" src="../../../images/avatar/avatar-2.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-warning avatar avatar-lg" href="#"><img class="bg-warning-light" src="../../../images/avatar/avatar-3.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-success avatar avatar-lg" href="#"><img class="bg-danger-light" src="../../../images/avatar/avatar-4.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-success avatar avatar-lg" href="#"><img class="bg-info-light" src="../../../images/avatar/avatar-5.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-danger avatar avatar-lg" href="#"><img class="bg-success-light" src="../../../images/avatar/avatar-6.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-warning avatar avatar-lg" href="#"><img class="bg-primary-light" src="../../../images/avatar/avatar-7.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-success avatar avatar-lg" href="#"><img class="bg-warning-light" src="../../../images/avatar/avatar-8.png" alt="..."></a>
														<div>
												...
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-danger avatar avatar-lg" href="#"><img class="bg-danger-light" src="../../../images/avatar/avatar-9.png" alt="..."></a>
														<div>
														  <a class="hover-primary mb-5" href="#"><strong>Alexa Fox</strong></a>
														  <p class="mb-0">See you there!</p>
														</div>
													</div>
													<div class="text-end">
													  <span class="d-block mb-5 fs-12">3:00 PM</span>
													  <span class="badge badge-primary">2</span>
													</div>
												</div>
												<div class="p-20 bb-1 d-flex align-items-center justify-content-between pull-up">
													<div class="d-flex align-items-center">
														<a class="me-15 status-warning avatar avatar-lg" href="#"><img class="bg-info-light" src="../../../images/avatar/avatar-10.png" alt="..."></a>
														<div>
														  <a class="hover-primary mb-5" href="#"><strong>John Cattle</strong></a>
														  <p class="mb-0">Hi, are you there?</p>
														</div>
													</div>
													<div class="text-end">
													  <span class="d-block mb-5 fs-12">4:12 AM</span>
													</div>
												</div>										
											</div>
										</div>
									...
									<div class="box">
									  <div class="box-body px-20 py-10 bb-1 bbsr-0 bber-0">
										<div class="d-md-flex d-block justify-content-between align-items-center w-p100">
											<div class="d-flex align-items-center">
												<a class="me-15 status-success avatar avatar-lg" href="#"><img class="bg-primary-light rounded-circle" src="../../../images/avatar/avatar-1.png" alt="..."></a>
												<div>
												  <a class="hover-primary mb-5" href="#"><strong>Mical Clark</strong></a>
											...
											<div class="mt-15 mt-md-0 d-flex align-items-center gap-2">
												<a href="#" class="waves-effect waves-circle btn btn-circle btn-primary-light btn-xs" data-bs-toggle="modal" data-bs-target="#modal-right"><i class="mdi mdi-information-outline"></i></a>
												<a href="#" class="waves-effect waves-circle btn btn-circle btn-primary-light btn-xs"><i class="mdi mdi-phone"></i></a>
												<a href="#" class="waves-effect waves-light btn btn-primary-light btn-sm">Inventory</a>
												<a href="#" class="waves-effect waves-light btn btn-primary-light btn-sm">Appointment</a>
												<a href="#" class="waves-effect waves-light btn btn-primary-light btn-sm">Location</a>
												<a href="#" class="hover-primary"><i class="fa fa-ellipsis-v"></i></a>
											</div>
										</div>								             
									  </div>
									  ...
									  <div class="box-body mb-20">
										  <div class="chat-box-six">
											  ...
											  <div class="rt-bx mb-30 d-flex align-items-start w-p100">
												<div>
													<a class="ms-15 status-success avatar avatar-lg" href="#"><img class="bg-danger-light rounded-circle" src="../../../images/avatar/avatar-2.png" alt="..."></a>
												</div>
												<div>
													...
													<div class="media">
													  ...
													  <div class="media-body">
														<p>
														  ...
														  <span class="float-end">23 hours ago</span>
														</p>
														<p>Nullam facilisis velit eu nulla dictum volutpat.</p>
													  </div>
													</div>
													<div class="media">
												...
												<div class="media-list media-list-hover">
													<div class="media media-single">
													  ...
													  <div class="media-body">
														...
														<small class="text-fade">12 mutual</small>
													  </div>

													  <div class="media-right">
														<a class="btn btn-block btn-sm btn-primary" href="#">Add</a>
													  </div>
													</div>
													<div class="media media-single">
													  <a href="#">
													  ...
													  <div class="media-body">
														...
														<small class="text-fade">1 mutual</small>
													  </div>

													  <div class="media-right">
														<a class="btn btn-block btn-primary btn-sm" href="#">Add</a>
													  </div>
													</div>
													<div class="media media-single">
													  <a href="#">
													  ...
													  <div class="media-body">
														...
														<small class="text-fade">22 mutual</small>
													  </div>
													...
													<div class="media media-single">
													  ...
													  <div class="media-body">
														...
														<small class="text-fade">34 mutual</small>
													  </div>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/Dashboard13.html"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-13.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:20 GMT -->
</html>
