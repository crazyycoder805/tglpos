...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/icons_fontawesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:39 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Icons </title>
			...
			<div class="box box-body">
			  ...
			  <h4 class="page-header mt-30">Web Application Icons</h4>
				<div class="row fontawesome-icon-list m-0">
					...
					<div class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-RubyXhairs" aria-hidden="true"></i> fa-RubyXhairs</div>
					...
					<div class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-Bsinx Admin" aria-hidden="true"></i> fa-Bsinx Admin <span class="text-muted">(alias)</span></div>
			  ...
			  <h4 class="page-header mt-30">Medical Icons</h4>
			   <div class="row fontawesome-icon-list m-0">
				...
				<div class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-fw fa-plus-square"></i> fa-plus-square</div>
				<div class="fa-hover col-xl-3 col-lg-4 col-md-6 col-12"><i class="fa fa-fw fa-stBsinx Admincope"></i> fa-stBsinx Admincope</div>
