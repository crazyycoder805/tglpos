...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:41 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Invoice </title>
			...
			<div class="row mt-4">
				...
				<div class="col-sm-4">
					<div class="text-sm-end">
						<img src="../../../images/qrcode.png" alt="barcode-image" class="w-150 img-fluid me-2" />
					</div>
				</div> <!-- end col-->
			</div>    
			<!-- end row -->        
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/invoice.js"></script>

</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:42 GMT -->
</html>
