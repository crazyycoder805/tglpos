...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_statistic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:22 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Statistic Widgets</title>
		...
		<section class="content">
		  ...
		  <div class="row">
			  <div class="col-lg-4 col-12">
			  	<div class="box bg-img" style="background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/abstract-1.svg);background-position: right top; background-size: 30% auto;">
					<div class="box-body">
						<a href="#" class="box-title fw-600 hover-primary fs-18">Travel Schedule</a>
			  ...
			  <div class="col-lg-4 col-12">
			  	<div class="box bg-img" style="background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/abstract-2.svg);background-position: right top; background-size: 30% auto;">
					<div class="box-body">
						<a href="#" class="box-title fw-600 hover-primary fs-18">Anuncio</a>
			  ...
			  <div class="col-lg-4 col-12">
			  	<div class="box bg-img" style="background-image: url(https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/abstract-3.svg);background-position: right top; background-size: 30% auto;">
					<div class="box-body">
						<a href="#" class="box-title fw-600 hover-primary fs-18">New Release</a>
				...
				<div class="box">
					<div class="box-body d-flex align-items-center pb-0">
						<div class="d-flex flex-column flex-grow-1">
							<a href="#" class="box-title fw-500 fs-18 mb-2 hover-primary">Top Agent</a>
			  ...
			  <div class="col-lg-4 col-12">
				<div class="box">
					<div class="box-body d-flex align-items-center pb-0">
						<div class="d-flex flex-column flex-grow-1">
							<a href="#" class="box-title fw-500 fs-18 mb-2 hover-primary">New Agent</a>
			  ...
			  <div class="col-lg-4 col-12">
				<div class="box">
					<div class="box-body d-flex align-items-center pb-0">
						<div class="d-flex flex-column flex-grow-1">
							<a href="#" class="box-title fw-500 fs-18 mb-2 hover-primary">Top Expert</a>
		  ...
		  <div class="row">
			...
			<div class="col-xl-4">
				<a href="#" class="box bg-hover-primary-light">
					<div class="box-body">
			...
			<div class="col-xl-4">
				<a href="#" class="box bg-hover-info-light">
					<div class="box-body">
			...
			<div class="col-xl-4">
				<a href="#" class="box bg-hover-warning-light">
					<div class="box-body">
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/statistic.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_statistic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:24 GMT -->
</html>
