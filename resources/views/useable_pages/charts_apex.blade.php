...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/charts_apex.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:06 GMT -->
<head>
  <meta charset="utf-8">
				...
				<div class="col-12 col-lg-6">
					<div class="card">
						<div class="card-header">
							...
							<h6 class="card-subtitle text-muted">A column chart uses vertical bars to display data and is used to compare values aRubyX categories.</h6>
						</div>
						<div class="card-body">
							<div class="chart">
