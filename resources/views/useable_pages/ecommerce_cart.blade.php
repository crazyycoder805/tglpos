...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ecommerce_cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:37 GMT -->
<head>
  <meta charset="utf-8">
									...
									<div class="table-responsive">
										<table class="table table-bordered table-centered mb-0">
											...
											<tbody>
												<tr>
													<td>
														<img src="../../../images/product/product-1.png" alt="" class="bg-gray-300 rounded me-3" height="64" />
														<p class="m-0 d-inline-block align-middle fs-16">
															<a href="#" class="text-body">Product name 1</a>
															<br>
												...
												<tr>
													<td>
														<img src="../../../images/product/product-2.png" alt="" class="bg-gray-300 rounded me-3" height="64" />
														<p class="m-0 d-inline-block align-middle fs-16">
															<a href="#" class="text-body">Product name 2</a>
															<br>
															<small class="text-fade me-2">Size: <span class="fw-500">Large</span> </small>
															<small class="text-fade me-2">Color: <span class="fw-500">Light Green</span> </small>
														</p>
												...
												<tr>
													<td>
														<img src="../../../images/product/product-3.png" alt="" class="bg-gray-300 rounded me-3" height="64" />
														<p class="m-0 d-inline-block align-middle fs-16">
															<a href="#" class="text-body">Product name 3</a>
															<br>
															<small class="text-fade me-2">Size: <span class="fw-500">Large</span> </small>
															<small class="text-fade me-2">Color: <span class="fw-500">Light Green</span> </small>
														</p>
												...
												<tr>
													<td>
														<img src="../../../images/product/product-4.png" alt="" class="bg-gray-300 rounded me-3" height="64" />
														<p class="m-0 d-inline-block align-middle fs-16">
															<a href="#" class="text-body">Product name 4</a>
															<br>
															<small class="text-fade me-2">Size: <span class="fw-500">Large</span> </small>
															<small class="text-fade me-2">Color: <span class="fw-500">Light Green</span> </small>
														</p>
									...
									<div class="row mt-4">
										...
										<div class="col-sm-6">
											<div class="text-sm-end">
												<a href="#" class="btn btn-primary"><i class="mdi mdi-cart-plus me-1"></i> Checkout </a>
											</div>
										</div> <!-- end col -->
									</div> <!-- end row-->
								</div>
