...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:45 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Timeline UI </title>
		...
		<section class="content">
			<div class="row">
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Timeline 1</h4>
						</div>
						<div class="box-body">
							<div class="timeline-label">
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">09:42</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-warning fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">Sed non libero at risus aliquet imperdiet.</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">18:00</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-success fs-14"></i>
									</div>
									<div class="timeline-content d-flex">
										<span class="fw-500 ps-3">Vivamus quis</span>
									</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">17:12</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-danger fs-14"></i>
									</div>
									<div class="timeline-content fw-500 ps-3">Cras lobortis 
									<a href="#" class="text-primary">USD 412</a>. to XYZ</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">15:23</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-primary fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">In eu massa sed lectus tempus blandit quis id orci.</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">23:41</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-danger fs-14"></i>
									</div>
									<div class="timeline-content fw-500 ps-3">Sed a lorem 
									<a href="#" class="text-primary">#41-4155</a>.</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">14:22</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-primary fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">Morbi blandit magna quis congue tristique.</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">08:33</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-danger fs-14"></i>
									</div>
									<div class="timeline-content fw-500 ps-3">New order placed 
									<a href="#" class="text-primary">#41-8457</a>.</div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">10:30</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-success fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">Phasellus condimentum erat sed ligula </div>
								</div>
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">11:11</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-danger fs-14"></i>
									</div>
									<div class="timeline-content fw-500 ps-3">Cras lobortis 
								...
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">21:32</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-primary fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">In eu massa sed lectus tempus blandit quis id orci.</div>
								...
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">03:22</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-danger fs-14"></i>
									</div>
									<div class="timeline-content fw-500 ps-3">Sed a lorem 
								...
								<div class="timeline-item">
									<div class="timeline-label fw-500 fs-16">17:44</div>
									<div class="timeline-badge">
										<i class="fa fa-dot-circle-o text-primary fs-14"></i>
									</div>
									<div class="timeline-content text-muted ps-3">Morbi blandit magna quis congue tristique.</div>
				...
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Timeline 2</h4>
						</div>
						<div class="box-body">
							<div class="timeline timeline-line-dotted">
								<span class="timeline-label">
									<span class="badge px-15 badge-danger-light badge-lg">17.03.2016</span>
								</span>
								<div class="timeline-item">
									...
									<div class="timeline-event">
										...
										<div class="timeline-body">
											<p>Donec pede justo, fringilla vel, aliquet nec</p>
										</div>
								...
								<span class="timeline-label">
									<span class="badge px-15 badge-danger-light badge-lg">09.03.2016</span>
								</span>
								<div class="timeline-item">
									<div class="timeline-point timeline-point-success">
										<i class="fa fa-circle"></i>
								...
								<span class="timeline-label">
									<span class="badge px-15 badge-danger-light badge-lg">09.02.2016</span>
								</span>
								<div class="timeline-item">
									<div class="timeline-point timeline-point-success">
										<i class="fa fa-circle"></i>
								...
								<span class="timeline-label">
									<a href="#" class="btn btn-info-light btn-circle" title="More...">
				...
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Timeline 3</h4>
						</div>
						<div class="box-body">
							<div class="timeline">
								<div class="timeline-item">
									...
									<div class="timeline-event timeline-event-default">
										...
										<div class="timeline-body">
											<p class="text-fade">Invitamus me testatur sed quod non dum animae tuae lacrimis.</p>
										</div>
										<div class="timeline-footer">
								...
								<span class="timeline-label">
									<span class="badge px-15 badge-danger-light badge-lg">timeline-label</span>
								</span>
								...
								<div class="timeline-item">
									...
									<div class="timeline-event timeline-event-primary-light">
										<div class="timeline-heading">
											<h4 class="timeline-title">timeline-event timeline-event-primary</h4>
										</div>
										<div class="timeline-body">
											<p class="text-fade">Stranguillione in deinde cepit roseo commendavit patris super color est se sed.</p>
										</div>
										<div class="timeline-footer">
								...
								<div class="timeline-item">
									...
									<div class="timeline-event timeline-event-info-light">
										<div class="timeline-heading">
											<h4 class="timeline-title">timeline-event timeline-event-info</h4>
										</div>
										<div class="timeline-body">
											<p class="text-fade">Advenientibus aliorum eam ad per te sed. Facere debetur aut veneris accedens.</p>
										</div>
										<div class="timeline-footer">
								...
								<div class="timeline-item">
									...
									<div class="timeline-event timeline-event-warning-light">
										<div class="timeline-heading">
								...
								<div class="timeline-item">
									...
									<div class="timeline-event timeline-event-danger-light">
										<div class="timeline-heading">
								...
								<span class="timeline-label">
									<button class="btn btn-danger-light btn-circle"><i class="fa fa-clock-o"></i></button>
								</span>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Timeline 4</h4>
						</div>
						<div class="box-body">
							<div class="timeline5">
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Timeline 5</h4>
						</div>
						<div class="box-body">
							<div class="timeline timeline-single-column timeline-single-full-column">
								...
								<span class="timeline-label">
									<span class="badge px-15 badge-primary-light badge-lg">label</span>
								</span>
								...
								<span class="timeline-label">
									<span class="badge px-15 badge-info-light badge-lg">label</span>
								</span>
								...
								<span class="timeline-label">
									<span class="badge badge-info-light badge-lg">Images</span>
								</span>
