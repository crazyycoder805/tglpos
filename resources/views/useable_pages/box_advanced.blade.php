...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/box_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:33 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Advanced Box </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Advanced Box</h4>
			...
			<div class="row">
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<p class="text-gray-600">Fusce commodo eros a vulputate accumsan. Nulla et mollis nibh. Donec sodales convallis urna luctus pulvinar. Ut vestibulum enim vitae elit luctus, id tincidunt metus suscipit.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box box-slided-up">
				  ...
				  <div class="box-body">
					...
					<div class="box-body">
					  <p class="text-gray-600">Ut vestibulum enim vitae elit luctus, id tincidunt metus suscipit. Pellentesque scelerisque, massa ut fringilla mollis, sem tortor pharetra mi, non consequat velit dui sed lorem.</p>
					</div>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
				<div class="box box-solid box-inverse box-primary">
				  <div class="box-header with-border">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<p class="text-gray-600">Donec sodales convallis urna luctus pulvinar. Ut vestibulum enim vitae elit luctus, id tincidunt metus suscipit. Pellentesque scelerisque, massa ut fringilla mollis, sem tortor pharetra.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<p class="text-gray-600">Nulla et mollis nibh. Donec sodales convallis urna luctus pulvinar. Ut vestibulum enim vitae elit luctus, id tincidunt metus suscipit. Pellentesque scelerisque, massa ut fringilla mollis.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<div class="callout callout-warning-light mb-20" role="alert">
					  Toggle button requires the box content to be wrapped inside a <code>.box-body</code>.
					</div>
					  <div class="box-body p-0">
					 	<p class="text-gray-600">Pellentesque scelerisque, massa ut fringilla mollis, sem tortor pharetra mi, non consequat velit dui sed lorem.</p>
					  </div>
				  </div>
				</div>
			  </div>
