...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:52 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Advanced form elements </title>
										...
										<div class="col-lg-6">
											<form>
												...
												<div class="mb-3">
													...
													<input class="form-control" id="example-color" type="color" name="color" value="#4d7cff">
												</div>
		  ...
		  <div class="row">
			...
			<div class="col-12">
			  <div class="box">
				  ...
				  <div class="box-body">
					...
					<h5 class="my-10">With colored Button Classes</h5>
						<div class="row">
							...
							<div class="col-sm-4">
								<select class="selectpicker mb-20" data-style="btn-secondary">
									<option data-tokens="Lorem">Sed posuere metus vel maximus fringilla.</option>
									<option data-tokens="ipsum">Nam in nisl a ligula semper euismod.</option>
									<option data-tokens="dolor">Ut rhoncus diam et elit tristique venenatis.</option>
								</select>
				...
				<div class="box-body">
					<p class="box-subtitle d-block mb-10">Add <code>data-role="tagsinput"</code> to your input field & its automatically change it to a tags input.</p>
					...
					<p class="box-subtitle d-block mb-10">You can also use group tag <code>data-role="tagsinput"</code> to your input field.</p>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:55 GMT -->
</html>
