...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/sample_coming_soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:43 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Coming soon </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Coming soon</h4>
		...
		<section class="content">
			  ...
			  <div class="box box-primary-light">
				<div class="box-header no-border">
				  <h4 class="box-title d-block text-center text-primary">Use these variety of pages to design a coming soon for your app.</h4>          
				</div>
			  </div>
			...
			<div class="row">
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					...
					<div class="box-body">
						<a class="d-light" href="sample_coming_soon_1.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-1.png" alt="welcome email page">
						</a>
						<a class="d-dark" href="sample_coming_soon_1_dark.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-1-dark.png" alt="welcome email page">
						</a>
					</div>
					<!-- /.box-body -->
				  </div>
				...
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					...
					<div class="box-body">
						<a class="d-light" href="sample_coming_soon_2.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-2.png" alt="Verify Emial page">
						</a>
						<a class="d-dark" href="sample_coming_soon_2_dark.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-2-dark.png" alt="Verify Emial page">
						</a>
					</div>
					<!-- /.box-body -->
				  </div>
				...
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					...
					<div class="box-body">
						<a class="d-light" href="sample_coming_soon_3.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-3.png" alt="Change Password page">
						</a>
						<a class="d-dark" href="sample_coming_soon_3_dark.html" target="_blank">
						  <img src="../../../images/preview/coming-soon-3-dark.png" alt="Change Password page">
						</a>
					</div>
					<!-- /.box-body -->
				  </div>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/sample_coming_soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:48 GMT -->
</html>
