...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_dropzone.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:59 GMT -->
<head>
  <meta charset="utf-8">
		...
		<section class="content">
		    <div class="box">
				<div class="box-header">					
					...
					<p class="mb-0 box-subtitle">For multiple file upload put class <code>.dropzone</code> to form.</p>
				</div>
				<div class="box-body">
