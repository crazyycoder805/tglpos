...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-15.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:21 GMT -->
<head>
		<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-xl-3 col-md-6 col-12">
							<div class="box">
								<div class="box-body">
									...
									<p class="mb-0 text-fade"><span class="text-success fw-600">+12.2%</span> last month</p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-12">
							<div class="box">
								<div class="box-body">
									<div class="d-flex justify-content-between align-items-center">
										<h3 class="fw-700 mt-0">4,789<span class="text-muted"><small> / month</small></span></h3>
									...
									<p class="mb-0 text-fade"><span class="text-success fw-600">+14.17%</span> last month</p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-12">
							<div class="box">
								<div class="box-body">
									<div class="d-flex justify-content-between align-items-center">
										<h3 class="fw-700 mt-0">8,695<span class="text-muted"><small> / month</small></span></h3>
										<div class="text-success fw-700 d-flex justify-content-between align-items-center">
									...
									<p class="mb-0 text-fade"><span class="text-danger fw-600">-5.18%</span> last month</p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6 col-12">
							<div class="box">
								<div class="box-body">
									<div class="d-flex justify-content-between align-items-center">
										<h3 class="fw-700 mt-0">$ 42k<span class="text-muted"><small> / month</small></span></h3>
										<div class="text-danger fw-700 d-flex justify-content-between align-items-center">
									...
									<p class="mb-0 text-fade"><span class="text-success fw-600">+11.00%</span> last month</p>
								</div>
							</div>
						</div>
						<div class="col-12">
							<div class="row">
								<div class="col-xl-3 col-md-6 col-12">
									<div class="box box-body pb-10 bs-4 border-primary pull-up">
									  <h6 class="text-uppercase text-fade">ON GOING</h6>
									  <div class="d-flex justify-content-between">
										<span class="fw-600 fs-30">154</span>
										<span class="fs-30 text-info mdi mdi-city"></span>
									  </div>
									</div>
								</div>
								<div class="col-xl-3 col-md-6 col-12">
									<div class="box box-body pb-10 bs-4 border-success pull-up">
									  <h6 class="text-uppercase text-fade">COMPLATE</h6>
									  <div class="d-flex justify-content-between">
										<span class="fw-600 fs-30">412</span>
								...
								<div class="col-xl-3 col-md-6 col-12">
									<div class="box box-body pb-10 bs-4 border-danger pull-up">
									  <h6 class="text-uppercase text-fade">COMMERCIAL</h6>
									  <div class="d-flex justify-content-between">
										<span class="fw-600 fs-30">125</span>
								...
								<div class="col-xl-3 col-md-6 col-12">
									<div class="box box-body pb-10 bs-4 border-warning pull-up">
									  <h6 class="text-uppercase text-fade">RESIDENTIAL</h6>
									  <div class="d-flex justify-content-between">
										<span class="fw-600 fs-30">256</span>
						...
						<div class="col-12 col-xl-4">
						  <div class="box">
							...
							<div class="box-body py-0 ps-0 pe-10">
						...
						<div class="col-12 col-xl-4 col-lg-6">
						  <div class="box">
							...
							<div class="box-body pt-0">
								<div id="chart-container" style="height: 321px;"></div>
							</div>
						  </div>
						</div>
						<div class="col-12 col-xl-4  col-lg-6">
								...
								<div class="box-body p-0">
								  <div class="media-list media-list-hover media-list-divided">
									...
									<a class="media media-single" href="#">
									  <img class="w-80 rounded m-0" src="../../../images/gallery/thumb-sm/1.jpg" alt="...">
									...
									<a class="media media-single" href="#">
									  <img class="w-80 rounded m-0" src="../../../images/gallery/thumb-sm/2.jpg" alt="...">
									  <div class="media-body">
									...
									<a class="media media-single" href="#">
									  <img class="w-80 rounded m-0" src="../../../images/gallery/thumb-sm/3.jpg" alt="...">
									  <div class="media-body">
										<h6>5 BHK polo Street, Sky View</h6>
										<small class="text-fader">By Klasan</small>
									  </div>
									</a>

									<a class="media media-single" href="#">
									  <img class="w-80 rounded m-0" src="../../../images/gallery/thumb-sm/4.jpg" alt="...">
									  <div class="media-body">
										<h6>1 BHK Moon Street, Sky View</h6>
										<small class="text-fader">By Smith</small>
									  </div>
									</a>
								  </div>
								</div>
							  <div class="text-center bt-3 border-light p-10">
								<a class="text-uppercase d-block font-size-14" href="#">See all recent posts</a>
							  </div>
							</div>
						</div>
						<div class="col-xxl-8 col-12">
							<div class="box">
								...
								<div class="box-body py-10 px-10 mt-1">
										...
										<table class="table product-overview mb-0">
											...
											<tbody>
												<tr>
													...
													<td><a href="javascript:void(0)" class="text-dark pe-10" data-bs-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a> 
														<a href="javascript:void(0)" class="text-dark" data-bs-toggle="tooltip" title="Delete"><i class="ti-trash"></i></a></td>
												</tr>
												<tr>
													<td>Adem Kalp</td>
													<td>#96523154</td>
...
<!-- ./wrapper -->
	...
	<script src="../../../../../fastly.jsdelivr.net/npm/echarts%405.5.1/dist/echarts.min.js"></script>

	
	<!-- Bsinx Admin App -->
	<script src="../src/js/demo.js"></script>
	<script src="../src/js/template.js"></script>
	<script src="../src/js/pages/dashboard15.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-15.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:24 GMT -->
</html>
