...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/jobs_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:51:22 GMT -->
<head>
  <meta charset="utf-8">
		...
		<section class="content">
			<div class="row">
						...
						<div class="box-body">
							...
							<div class="d-md-flex justify-content-between align-items-center">
								<div>
									...
									<p class="text-fade">Globel Inc. - Miami, Florida</p>
								</div>
								<a href="jobs.html" class="waves-effect waves-light btn btn-outline btn-success mt-10 mt-md-0">Sponsor this job</a>
							</div>
							<hr>
							<div class="row">
								<div class="col-12">
								...
								<div class="col-xl-4 col-12">
									<div>
										...
										<h1>122</h1>
										<a href="jobs.html" class="mt-20 waves-effect waves-light btn btn-block w-p100 btn-outline btn-primary">Sponsor Job for More Clicks</a>
										<a href="jobs.html" class="mt-5 waves-effect waves-light btn btn-block w-p100 btn-outline btn-warning">Improve Job Description</a>
									</div>
								</div>
							</div>
							<hr>
							<div class="row">
								...
								<div class="col-md-6 col-12">
									<div class="text-center b-1 bg-nav-pills p-30 Awaiting_box mb-2">
										<h6 class="mt-0 text-fade">Awaiting Review</h6>
										<h1 class="mb-0 text-fade">41</h1>
									</div>
								</div>
								<div class="col-md-6 col-12">
									<div class="text-center b-1 bg-nav-pills p-30 Awaiting_box mb-2">
									...
									<div class="bg-primary-light p-15">
										<div class="d-md-flex justify-content-between align-items-center">
											<div>												
												...
												<h4 class="text-primary">Discover your top applicants faster by sending a free assessment</h4>
												<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
												<a href="jobs.html" class="mt-md-0 mt-10 waves-effect waves-light btn btn-primary d-table text-nowrap">Choose Assessment</a>
											</div>
							...
							<div class="row">
								<div class="col-12">
									...
									<p class="text-fade">Expected Stan Date: 23/11/2020 </p>
									<p class="text-fade">Job Types: Full-time, Fresher </p>
									<p class="text-fade">Salary: From $8,000.00 per month</p>
									<h5 class="fw-500">Speak with the employer</h5>
									<p class="text-fade">+1 123 456 7890 </p>
								</div>
							</div>
							<hr>
							<div class="row">
								<div class="col-12">
									<h4 class="mb-25">Application Questions </h4>
				...
				<div class="col-lg-4 col-12">
					<div class="box">
						<div class="box-body">
							<a href="jobs.html" class="waves-effect waves-light btn btn-block w-p100 btn-primary mb-15">Edit Job</a>
							<div class="media-list media-list-hover media-list-divided">
								<a class="media media-single rounded-0" href="#">
								  <span class="title mx-0 text-fade">Close Job </span>
								...
								<a class="media media-single rounded-0" href="#">
								  <span class="title mx-0 text-fade">Find Candidates for this Job</span>
								  <span class="badge badge-pill badge-secondary-light mx-0"><i class="fa fa-arrow-right"></i></span>
								</a>
						    </div>
							<a href="jobs.html" class="waves-effect waves-light btn btn-block w-p100 btn-outline btn-success my-15">Add Candidate</a>
							<div>
							...
							<a href="jobs.html" class="waves-effect waves-light btn btn-block w-p100 btn-outline btn-danger my-15">View Public job page</a>
							<p class="text-fade">Promote this job for more candidates:</p>
							<a href="#" class="p-5 bg-facebook text-white d-inline-block mb-10 rounded"><i class="fa fa-facebook-f"></i> Share 0</a>
							<a href="#" class="p-5 bg-twitter text-white d-inline-block mb-10 rounded"><i class="fa-brands fa-x-twitter"></i> Tweet</a>
							<a href="#" class="p-5 bg-linkedin text-white d-inline-block mb-10 rounded"><i class="fa fa-linkedin-square"></i> Share</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/jobs_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:51:23 GMT -->
</html>
