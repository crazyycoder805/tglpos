...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_color_utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Color Class Utilities </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Color utilities</h4>
		...
		<section class="content">
			<div class="row">
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Primary Background Colors</h4>
						</div>
						<div class="card-body">
							<div class="example-preview">
								<p class="bg-primary text-white py-2 px-4">.bg-primary</p>
								<p class="bg-secondary py-2 px-4 text-white">.bg-secondary</p>
				...
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Primary light Background Colors</h4>
						</div>
						<div class="card-body">
							<div class="example-preview">
								<p class="bg-primary-light py-2 px-4">.bg-primary</p>
								<p class="bg-secondary-light py-2 px-4 text-white">.bg-secondary</p>
								<p class="bg-success-light py-2 px-4">.bg-success</p>
								<p class="bg-danger-light py-2 px-4">.bg-danger</p>
								<p class="bg-warning-light py-2 px-4">.bg-warning</p>
								<p class="bg-info-light py-2 px-4">.bg-info</p>
							</div>	
						</div>
					</div>
				</div>
				<div class="col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Hover Background Colors</h4>
						</div>
						<div class="card-body">
							<div class="example mb-15">
								...
								<div class="example-preview">
									<div class="d-flex">
										<div class="bg-gray-200 bg-hover-primary d-flex flex-center w-100 h-100 me-5 mb-1 mb-md-0"></div>
										<div class="bg-gray-200 bg-hover-success d-flex flex-center w-100 h-100 me-5 mb-1 mb-md-0"></div>
										<div class="bg-gray-200 bg-hover-danger d-flex flex-center w-100 h-100 me-5 mb-1 mb-md-0"></div>
										<div class="bg-gray-200 bg-hover-warning d-flex flex-center w-100 h-100 me-5 mb-1 mb-md-0"></div>
										<div class="bg-gray-200 bg-hover-dark d-flex flex-center w-100 h-100 me-5 mb-1 mb-md-0"></div>
										<div class="bg-gray-200 bg-hover-info d-flex flex-center w-100 h-100"></div>
									</div>
								</div>								
							</div>
						</div>
				...
				<div class="col-12">
					<div class="box">
						<div class="box-header">
							<h4 class="box-title">Bootstrap Background Colors</h4>
						</div>
						<div class="card-body">
							<div class="example-preview">
								...
								<p class="bg-gray-400 text-white-50 py-2 px-4">.bg-gray-400</p>
								<p class="bg-gray-500 text-white-50 py-2 px-4">.bg-gray-500</p>
		  ...
		  <div class="box">
			  <div class="box-header with-border">
				<h4 class="box-title">Gradient colors</h4>
			  </div>

			  <div class="box-body">
				<div class="example-preview">					
				  <h5>gradient colors</h5>
				  <p class="rounded py-2 px-4 text-white bg-gradient-primary">.bg-gradient-primary</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-secondary">.bg-gradient-secondary</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-info">.bg-gradient-info</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-success">.bg-gradient-success</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-danger">.bg-gradient-danger</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-warning">.bg-gradient-warning</p>
				</div>

				<div class="example-preview">					
				  <h5>gradient colors</h5>
				  <p class="rounded py-2 px-4 text-white bg-gradient-primary-dark">.bg-gradient-primary-dark</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-secondary-dark">.bg-gradient-secondary-dark</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-info-dark">.bg-gradient-info-dark</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-success-dark">.bg-gradient-success-dark</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-danger-dark">.bg-gradient-danger-dark</p>
				  <p class="rounded py-2 px-4 text-white bg-gradient-warning-dark">.bg-gradient-warning-dark</p>
				</div>
		  </div>
			</div>
		  <!-- /.box -->
		  ...
		  <div class="box">
			  <div class="box-header with-border">
				<h4 class="box-title">SVG Img Background</h4>
			  </div>
		  ...
		  <!-- /.box -->
			...
			<div class="box">
			  <div class="box-header with-border">
				<h4 class="box-title">Border colors</h4>
			  </div>
