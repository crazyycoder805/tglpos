...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:47:59 GMT -->
<head>
		<meta charset="utf-8">
					...
					<div class="row">
							...
							<div class="box pull-up">
								<div class="box-body p-20">
									<div class="d-flex justify-content-between align-items-center">
										<div>
											<h2 class="mt-0 mb-5 fw-500">4.56k</h2>
											<p class="text-fade mb-0">Sales Today </p>						
										</div>
										<div class="icon">
											<i class="fa fa-truck bg-success me-0 fs-20"></i>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body p-20">
									<div class="d-flex justify-content-between align-items-center">
										<div>
											<h2 class="mt-0 mb-5 fw-500">27.4k</h2>
											<p class="text-fade mb-0">Visitors Today</p>						
										</div>
										<div class="icon">
											<i class="fa fa-bolt bg-warning me-0 fs-20"></i>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body p-20">
									<div class="d-flex justify-content-between align-items-center">
										<div>
											<h2 class="mt-0 mb-5 fw-500">$ 29.2k</h2>
											<p class="text-fade mb-0">Total Earnings</p>						
										</div>
										<div class="icon">
											<i class="fa fa-shopping-cart bg-danger me-0 fs-20"></i>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body p-20">
									<div class="d-flex justify-content-between align-items-center">
										<div>
											<h2 class="mt-0 mb-5 fw-500">45</h2>
											<p class="text-fade mb-0">Pending Orders</p>						
										</div>
										<div class="icon">
											<i class="fa fa-bullhorn bg-success me-0 fs-20"></i>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-xl-6 col-12">
									<div class="box">
										<div class="box-header no-border">
											<h4 class="box-title">Email Campaign</h4>
										</div>
										<div class="box-body pt-0 pb-15">
											<div class="">
								...
								<div class="col-xl-6 col-12">							
									<div class="box">
									  <div class="box-body">
										<div class="d-flex justify-content-between align-items-center">
											<div>
												<h1 class="fw-700 mt-0 mb-5">20k </h1>
												<p class="text-fade mb-0">Montly Income</p>
											</div>
											<div class="bg-info-light bg-hover-info px-30 py-10 text-center rounded hover-white border-info b-1"><i class="ti-arrow-down"></i></div>
										</div>
									  </div>
									</div>
									<div class="box bg-danger">
										<div class="box-body">
											<div class="d-flex justify-content-between align-items-center">
												<div class="">									
													<h1 class="fw-700 mt-0 mb-5">21k</h1>
									...
									<div class="box overflow-hidden">
										<div class="box-body">
										  	<div class="d-flex justify-content-between align-items-center">
												<div>
													<h1 class="fw-700 mt-0 mb-5">205k </h1>
													<p class="text-fade mb-0">Today Income</p>
												</div>
												<div class="bg-success-light bg-hover-success px-30 py-10 text-center rounded hover-white border-success b-1"><i class="ti-arrow-down"></i></div>
											</div>
										</div>
						...
						<div class="col-xl-6 col-12">
							<div class="box">
								...
								<div class="box-body">
									<div class="chart">
										<div id="line-chart" style="height: 246px;"></div>
									</div>
								</div>
							</div>
							<div class="box">
						...
						<div class="col-12">
							<div class="box bg-gradient-primary">						
								<div class="box-body">
									<div class="row">
										<div class="col-xl-6 col-12">
											<h3 class="text-white mt-0 mb-50">Revenue Overview </h3>
											<div class="d-sm-flex justify-content-between align-items-end">
												<div class="d-flex">
													<div class="icon me-30">
														<i class="fa fa-trophy"></i>
													</div>
													<div>
														<h3 class="fw-600 text-white mb-0 mt-0">3404</h3>
														<p class="text-white-50">Revenue</p>
														<h5 class="text-white">+34040 <span class="ms-40"><i class="fa fa-angle-down me-10"></i><span class="text-white-50">0.03%</span></span> </h5>
													</div>
												</div>
												<div>
										...
										<div class="col-xl-6 col-12">
											<h3 class="text-white mb-50 mt-xl-0 mt-60">Sales Overview </h3>
											<div class="d-sm-flex justify-content-between align-items-end">
												<div class="d-flex">
													<div class="icon me-30">
														<i class="fa fa-trophy"></i>
													...
													<div>
														...
														<h5 class="text-white">-6.209  <span class="ms-40"><i class="fa fa-angle-down me-10"></i><span class="text-white-50">2.03%</span></span> </h5>
													</div>										
												</div>
												<div>
