...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/box_basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:34 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Basic Box </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Basic Box</h4>
			...
			<div class="row">
			  <div class="col-xl-6 col-12">
				<div class="box">
				  <div class="box-body">
					...
					<p class="text-gray-600">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
				<div class="box">
				  <div class="box-body">
					...
					<p class="text-gray-600">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
				<div class="box">
				  <div class="box-body">
					...
					<p class="text-gray-600">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					...
					<p class="text-gray-600">At vero eos et accusamus et iusto odio dignissimos ducimus qui..</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					...
					<p class="text-gray-600">At vero eos et accusamus et iusto odio dignissimos ducimus.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box box-hover-shadow no-shadow">
				  ...
				  <div class="box-body">
					...
					<p class="text-gray-600">Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-footer">
					<p class="text-gray-600">A footer for more content inside</p>
				  </div>
				</div>
			  </div>
			  <div class="col-xl-6 col-12">
			  ...
			  <div class="col-xl-6 col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<p><code>div.box-footer</code></p>
					<p class="text-gray-600">Atque corrupti quos dolores et quas molestias excepturi sint occaecati.</p>
				  </div>
