...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/charts_inline.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:04 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Inline Chart </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Inline chart</h4>
			...
			<div class="col-12">
			  <div class="box">
				...
				<div id="myBody" class="box-body">
				  <div class="row">
					<div class="col-12 col-sm-6 text-fade">
					  <p>
