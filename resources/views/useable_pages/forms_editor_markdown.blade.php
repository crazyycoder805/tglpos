...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_editor_markdown.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:02 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Markdown </title>
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header with-border">
					  ...
					  <p class="box-subtitle mb-0">You can find the <a href="https://github.com/toopay/bootstrap-markdown" class="text-primary" target="_blank">offical website </a></p>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
			...
			laboris nisi ut aliquip ex ea commodo consequat [link is here](http://www.github.com)(http://www.github.com)</textarea>
			 ...
			 <div class="col-12">
				<div class="box">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<p class="text-fade">Inline editing with
			...
			<div class="row">
				<div class="col-12">
					<div class="box">
						...
						<div class="box-body">
							<form>
							<p class="text-fade">Custom width using <code>data-width="600"</code> attribute</p>
							<div class="example example-responsive">
							  <textarea data-provide="markdown" data-iconlibrary="fa" data-width="600"></textarea>
							</div>
							</form>
						</div>
						<!-- /.box-body -->			
				 ...
				 <div class="col-12">
					<div class="box">
						...
						<div class="box-body">
							<form>
							<p class="text-fade">Hidden buttons using <code>data-hidden-buttons="cmdBold"</code>attribute</p>
							<div class="example">
			...
			<div class="row">
				<div class="col-12">
					<div class="box">
						...
						<div class="box-body">
							<form>
							<p class="text-fade">Hideable on blur using <code>data-hideable="true"</code> attribute</p>
							<div class="example">
				 ...
				 <div class="col-12">
					<div class="box">
						...
						<div class="box-body">
							<form>
							<p class="text-fade">Savable using <code>data-savable="true"</code> attribute</p>
							<div class="example">
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/forms_editor_markdown.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:03 GMT -->
</html>
