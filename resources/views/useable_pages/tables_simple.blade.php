...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/tables_simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:09 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Basic Tables </title>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							...
							<p class="mb-0 card-subtitle text-muted">ARubyX every breakpoint, use <code>.table-responsive</code> for horizontally scrolling tables.</p>
						</div>						
						<div class="card-body">
