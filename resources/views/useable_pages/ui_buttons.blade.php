...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:38 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Button UI </title>
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-xl-6 col-12">	
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-15">Light Buttons</h4>
							<div class="clearfix">
				...
				<div class="col-xl-6 col-12">					
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-15">Light Rounded Buttons</h4>
							<div class="clearfix">
				...
				<div class="col-xl-6 col-12">					
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-15">light Button with outline</h4>
							<div class="clearfix">
				...
				<div class="col-xl-6 col-12">					
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-15">Light Rounded Outline Buttons</h4>
							<div class="clearfix">
				...
				<div class="col-xl-6 col-12">					
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-15">Light Flat Buttons</h4>
							<div class="clearfix">
				...
				<div class="col-12">
					...
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-5">Social buttons Icon with Name</h4>
						  <p class="subtitle mb-20">Use a classes <code>waves-effect waves-light btn btn-social btn-bitbucket-light /  &lt; class="fa fa-bitbucket"&gt;&lt;/i&gt;</code> to quickly create a General btn.</p>
							<div class="clearfix">					
							  <button class="waves-effect waves-light btn btn-social btn-bitbucket-light mb-5">
								<i class="me-10 fa fa-bitbucket"></i> Sign in with Bitbucket
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-dropbox-light mb-5">
								<i class="me-10 fa fa-dropbox"></i> Sign in with Dropbox
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-facebook-light mb-5">
								<i class="me-10 fa fa-facebook"></i> Sign in with Facebook
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-flickr-light mb-5">
								<i class="me-10 fa fa-flickr"></i> Sign in with Flickr
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-foursquare-light mb-5">
								<i class="me-10 fa fa-foursquare"></i> Sign in with Foursquare
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-github-light mb-5">
								<i class="me-10 fa fa-github"></i> Sign in with GitHub
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-google-light mb-5">
								<i class="me-10 fa fa-google-plus"></i> Sign in with Google
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-instagram-light mb-5">
								<i class="me-10 fa fa-instagram"></i> Sign in with Instagram
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-linkedin-light mb-5">
								<i class="me-10 fa fa-linkedin"></i> Sign in with LinkedIn
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-tumblr-light mb-5">
								<i class="me-10 fa fa-tumblr"></i> Sign in with Tumblr
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-twitter-light mb-5">
								<i class="me-10 fa-brands fa-x-twitter"></i> Sign in with Twitter
							  </button>
							  <button class="waves-effect waves-light btn btn-social btn-vk-light mb-5">
								<i class="me-10 fa fa-vk"></i> Sign in with VK
							  </button>
							</div>
						</div>
						...
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Use a classes <code>waves-effect waves-light btn btn-social-icon btn-bitbucket</code> to quickly create a General btn.</p>
							<div class="clearfix">
								...
								<button class="waves-effect waves-light btn btn-social-icon btn-twitter"><i class="fa-brands fa-x-twitter"></i></button>
						...
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Use a classes <code>btn btn-social-icon btn-circle</code> to quickly create a General btn.</p>
							<div class="clearfix">
								...
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-twitter"><i class="fa-brands fa-x-twitter"></i></button>
				...
				<div class="col-xl-6 col-12">
					<div class="box">
						<div class="box-body">
						  <h4 class="box-title mb-5">Social buttons Icon</h4>
						  <p class="subtitle mb-20">Use a classes <code>waves-effect waves-light btn btn-social-icon btn-bitbucket-light</code></p>
							<div class="clearfix">
								<button class="waves-effect waves-light btn btn-social-icon btn-bitbucket-light"><i class="fa fa-bitbucket"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-dropbox-light"><i class="fa fa-dropbox"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-facebook-light"><i class="fa fa-facebook"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-flickr-light"><i class="fa fa-flickr"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-foursquare-light"><i class="fa fa-foursquare"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-github-light"><i class="fa fa-github"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-google-light"><i class="fa fa-google-plus"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-instagram-light"><i class="fa fa-instagram"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-linkedin-light"><i class="fa fa-linkedin"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-tumblr-light"><i class="fa fa-tumblr"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-twitter-light"><i class="fa-brands fa-x-twitter"></i></button>
								<button class="waves-effect waves-light btn btn-social-icon btn-vk-light"><i class="fa fa-vk"></i></button>
							</div>
						</div>
					</div>
					<div class="box">
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Use a classes <code>btn btn-social-icon btn-circle</code> to quickly create a General btn.</p>
							<div class="clearfix">
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-bitbucket-light"><i class="fa fa-bitbucket"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-dropbox-light"><i class="fa fa-dropbox"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-facebook-light"><i class="fa fa-facebook"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-flickr-light"><i class="fa fa-flickr"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-foursquare-light"><i class="fa fa-foursquare"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-github-light"><i class="fa fa-github"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-google-light"><i class="fa fa-google-plus"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-instagram-light"><i class="fa fa-instagram"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-linkedin-light"><i class="fa fa-linkedin"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-tumblr-light"><i class="fa fa-tumblr"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-twitter-light"><i class="fa-brands fa-x-twitter"></i></button>
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-vk-light"><i class="fa fa-vk"></i></button>
							</div>
						</div>
					</div>
				</div>
				<div class="col-12">
					...
					<div class="box">
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Add the classes <code>.btn.btn-app</code> to an <code>&lt;a&gt;</code> tag to achieve the following:</p>
							<div class="clearfix">
								  <a class="waves-effect waves-light btn btn-app btn-info-light" href="#">
									<i class="fa fa-edit"></i> Edit
								  </a>
								  <a class="waves-effect waves-light btn btn-app btn-success-light" href="#">
									<i class="fa fa-play"></i> Play
								  </a>
								  <a class="waves-effect waves-light btn btn-app btn-primary-light" href="#">
									<i class="fa fa-stop"></i> Stop
								  </a>
								  <a class="waves-effect waves-light btn btn-app btn-warning-light" href="#">
									<i class="fa fa-repeat"></i> Repeat
								  </a>
								  <a class="waves-effect waves-light btn btn-app btn-danger-light" href="#">
									<i class="fa fa-save"></i> Save
								  </a>
								  <a class="btn btn-app btn-warning-light" href="#">
									<span class="badge bg-danger">12</span>
									<i class="fa fa-bullhorn"></i> Notifications
								  </a>
								  <a class="btn btn-app btn-warning-light" href="#">
								  ...
								  <a class="btn btn-app btn-primary-light" href="#">
									<span class="badge bg-success">45</span>
									<i class="fa fa-inbox"></i> Orders
								  </a>
								  <a class="btn btn-app btn-success-light" href="#">
									<span class="badge bg-info">2</span>
									<i class="fa fa-envelope"></i> Inbox
								  </a>
								  <a class="btn btn-app btn-danger-light" href="#">
									<span class="badge bg-success">48</span>
									<i class="fa fa-barcode"></i> Products
								  </a>
								  <a class="btn btn-app btn-info-light" href="#">
									<span class="badge bg-danger">31</span>
									<i class="fa fa-heart-o"></i> Likes
								  </a>
							</div>
