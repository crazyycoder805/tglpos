...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/extension_pace.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:49 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Profile </title>
	  ...
	  <div class="container-full">
		...
		<section class="content">
		  ...
		  <div class="box">
			...
			<div class="box-body">
			  <p class="text-fade">Pace loading works automatically on page. You can still implement it with ajax requests by adding this js:</p>
			  <br/><code>$(document).ajaxStart(function() { Pace.restart(); });</code>
			  <br/>
			  <div class="row">
				<div class="col-12 text-center">
				  <button type="button" class="btn btn-info-light ajax" title="Ajax Request">
...
<!-- ./wrapper -->
    ...
    <script src="../../../assets/icons/feather-icons/feather.min.js"></script>	<script src="../../../assets/vendor_components/PACE/pace.min.js"></script>
