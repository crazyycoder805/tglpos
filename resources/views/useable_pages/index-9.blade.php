...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:13 GMT -->
<head>
		<meta charset="utf-8">
			...
			<div class="row">
					...
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-center mb-15">
								<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/employees.svg" width="50" alt="">
								<h4 class="fw-500 my-0 ms-10">Total employees</h4>
							</div>
							<div class="d-flex align-items-center justify-content-between">
								<h1 class="fw-600 my-0">352</h1>
								<h6 class="fw-500 my-0 text-success"><i class="me-10 mdi mdi-arrow-top-right"></i> +15%</h6>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-center mb-15">
								<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/no-leave.svg" width="50" alt="">
								<h4 class="fw-500 my-0 ms-10">Number of leave</h4>
							</div>
							<div class="d-flex align-items-center justify-content-between">
								<h1 class="fw-600 my-0">22</h1>
								<h6 class="fw-500 my-0 text-danger"><i class="me-10 mdi mdi-arrow-bottom-right"></i> -10%</h6>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-center mb-15">
								<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/new-employees.svg" width="50" alt="">
								<h4 class="fw-500 my-0 ms-10">New employees</h4>
							</div>
							<div class="d-flex align-items-center justify-content-between">
								<h1 class="fw-600 my-0">32</h1>
								<h6 class="fw-500 my-0 text-success"><i class="me-10 mdi mdi-arrow-top-right"></i> +12%</h6>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6 col-12">
					<div class="box">
						<div class="box-body">
							<div class="d-flex align-items-center mb-15">
								<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/svg-icon/color-svg/happinnes-rate.svg" width="50" alt="">
								<h4 class="fw-500 my-0 ms-10">Happinnes rate</h4>
							</div>
							<div class="d-flex align-items-center justify-content-between">
								<h1 class="fw-600 my-0">82%</h1>
								<h6 class="fw-500 my-0 text-danger"><i class="me-10 mdi mdi-arrow-bottom-right"></i> -11%</h6>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="box">
						...
						<div class="box-body">
							<div class="d-flex align-items-center justify-content-center">
								<div id="chart41"></div>
								<div>
									<p class="fw-400 my-0"><span class="me-10 badge badge-xl badge-dot badge-primary"></span> 50 Employee Hybrid</p>
									<p class="fw-400 my-0"><span class="me-10 badge badge-xl badge-dot badge-danger"></span> 20 Employee onsite</p>
									<p class="fw-400 my-0"><span class="me-10 badge badge-xl badge-dot badge-warning"></span> 30 Employee Remote</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-8">
					<div class="box">
						<div class="box-header no-border pb-0">
							<h4 class="box-title">Attendance Overview</h4>
							<div class="btn-group float-end">
							  <button class="btn btn-sm btn-light dropdown-toggle m-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">Week </button>
						...
						<div class="box-body px-0">							
							<div class="table-responsive">
							  <table class="table table-borderless mb-0">
								  ...
								  <tbody>
									<tr>
									  <td><h6 class="fw-500 my-0 min-w-150"><img src="../../../images/avatar/14.jpg" class="avatar me-10 bg-primary-light" alt=""> Dom Sibley</h6></td>
									  <td><h6 class="fw-500 my-0">Devops</h6></td>
									  <td><h6 class="fw-500 my-0"><span class="me-10 badge badge-dot badge-primary"></span> Tech interview</h6></td>
									</tr>
									<tr>
									  <td><h6 class="fw-500 my-0 min-w-150"><img src="../../../images/avatar/11.jpg" class="avatar me-10 bg-danger-light" alt=""> Joe Root</h6></td>
									  <td><h6 class="fw-500 my-0">UX/UI Designer</h6></td>
									  <td><h6 class="fw-500 my-0"><span class="me-10 badge badge-dot badge-danger"></span> Resume review</h6></td>
									</tr>
									<tr>
									  <td><h6 class="fw-500 my-0 min-w-150"><img src="../../../images/avatar/12.jpg" class="avatar me-10 bg-warning-light" alt=""> Zak Crawley</h6></td>
									  <td><h6 class="fw-500 my-0">.Net developer</h6></td>
									  <td><h6 class="fw-500 my-0"><span class="me-10 badge badge-dot badge-warning"></span> Final interview</h6></td>
									</tr>
								  </tbody>
								</table>
							</div>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard9.js"></script>

	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:14 GMT -->
</html>
