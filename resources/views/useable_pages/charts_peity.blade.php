...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/charts_peity.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:05 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Peity </title>
		  ...
		  <div class="row">
				...
				<div class="box-body">
					<div class="row gap-y">
					  ...
					  <div class="col-6 col-md-2 text-center">
						...
						<p class="text-fade"><small>226,134</small></p>
					  </div>

					  <div class="col-6 col-md-2 text-center">
						<span class="donut" data-peity='{ "fill": ["#3e8ef7", "#faa700", "#ff4c52"], "radius": 36 }' >1,2,1</span>
						<p class="text-fade"><small>1,2,1</small></p>
					  </div>
					</div>
				</div>
			  </div>
			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-body">
				  <p class="text-fade"><code>class="pie"</code> applies to <em>&lt;span&gt;</em></p>
					<div class="row gap-y">
					  <div class="col-6 col-md-2 text-center">
					  ...
					  <div class="col-6 col-md-2 text-center">
						...
						<p class="text-fade"><small>3,2,1</small></p>
					  </div>
					</div>
				</div>
			  </div>
