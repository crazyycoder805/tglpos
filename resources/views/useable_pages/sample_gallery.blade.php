...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/sample_gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:49 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Gallery </title>
		  ...
		  <div id="gallery">
			  <div class="box bg-transparent no-shadow b-0">
				<div class="box-body text-center p-0">
					<div class="btn-group">
					  <button class="btn btn-primary-light" id="filter-all">All</button>
					  <button class="btn btn-primary-light" id="filter-studio">Studio</button>
					  <button class="btn btn-primary-light" id="filter-landscape">Landscapes</button>
					</div>
				</div>
			  </div>
			  <!-- Default box -->
...
<!-- ./wrapper -->
    ...
    <script src="../src/js/pages/gallery.js"></script>
	

</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/sample_gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:59 GMT -->
</html>
