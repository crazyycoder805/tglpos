...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_animations.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:48 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Animations </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Animations - CSS3 Animations</h4>
		...
		<section class="content">
			...
			<div class="box b-1 bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Attention seekers</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Bouncing entrances</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Bouncing exits</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Fading entrances</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Fading exits</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Flip animations</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Lightspeed animations</h4>
			...
			<div class="box">
				<div class="box-header">
					<h4 class="box-title text-primary">Rotating entrances</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Rotating exits</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Special animations</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Zoom entrances</h4>
			...
			<div class="box b-1  bg-primary-light">
				<div class="box-header">
					<h4 class="box-title text-primary">Zoom exits</h4>
