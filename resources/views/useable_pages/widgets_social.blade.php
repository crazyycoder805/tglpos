...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_social.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:21 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Social Widgets</title>
		  ...
		  <div class="row">
			  	...
			  	<div class="box">
					...
					<div class="box-body">
						...
						<ul class="list-inline text-center text-fade">
							<li><a href="javascript:void(0)" data-bs-toggle="tooltip" title="Website" class="text-fade hover-primary"><i class="fa fa-globe fs-20"></i></a></li>
							<li><a href="javascript:void(0)" data-bs-toggle="tooltip" title="twitter" class="text-fade hover-primary"><i class="fa-brands fa-x-twitter fs-20"></i></a></li>
							<li><a href="javascript:void(0)" data-bs-toggle="tooltip" title="Facebook" class="text-fade hover-primary"><i class="fa fa-facebook-square fs-20"></i></a></li>
						</ul>
					</div>
				</div>
			  </div>			  
			  <div class="col-lg-4 col-12">
				<div class="box">
					<div class="box-body text-center">
						...
						<div class="badge badge-warning-light fs-16" data-bs-toggle="tooltip" data-placement="top" title="3 more">+10</div>
					</div>
			  ...
			  <div class="col-lg-4 col-12">
				<div class="box">
				  <div class="text-white box-body bg-img text-center py-50" style="background-image: url(../../../images/gallery/creative/img-12.jpg);" data-overlay="5">
					...
					<h3 class="mt-2 mb-0"><a class="text-white" href="#">Nil Yeager</a></h3>
					<span>Manager</span>
				  </div>
			  ...
			  <div class="col-md-6 col-lg-4">
				<div class="box p-30 pt-50 text-center">
				  ...
				  <h4 class="mt-5 mb-5"><a class="text-default hover-primary" href="#">Harmani Potter</a></h4>
				  ...
				  <div class="gap-items">
					<a class="text-facebook btn btn-circle btn-facebook" href="#"><i class="fa fa-facebook"></i></a>
					<a class="text-instagram btn btn-circle btn-instagram" href="#"><i class="fa fa-instagram"></i></a>
					<a class="text-google btn btn-circle btn-google" href="#"><i class="fa fa-google"></i></a>
					<a class="text-twitter btn btn-circle btn-twitter" href="#"><i class="fa-brands fa-x-twitter"></i></a>
				  </div>
				</div>
			  </div>
			  <div class="col-lg-4 col-12">
			  ...
			  <div class="col-md-6 col-lg-4">
				<div class="box box-inverse bg-twitter">
				  ...
				  <blockquote class="blockquote blockquote-inverse no-border m-0 py-15">
					<p>Holisticly benchmark plug imperatives for multifunctional deliverables. Seamlessly incubate RubyX functional action.</p>
					<div class="flexbox">
					  <time class="text-white" datetime="2023-11-21 20:00">21 November, 2023</time>
					  ...
					  <div class="carousel-inner">
						  <div class="carousel-item active">
							  <blockquote class="blockquote blockquote-inverse no-border m-0 py-15">
								  <p>Holisticly benchmark plug imperatives for multifunctional deliverables. Seamlessly incubate RubyX functional action.</p>
								  <div class="flexbox">
									<time class="text-white" datetime="2023-11-22 20:00">22 November, 2023</time>
						  ...
						  <div class="carousel-item">
							  <blockquote class="blockquote blockquote-inverse no-border m-0 py-15">
								  <p>Enthusiastically optimize RubyX-media manufactured products without process-centric web services. Conveniently.</p>
								  <div class="flexbox">
									<time class="text-white" datetime="2023-11-22 20:00">22 November, 2023</time>
				  ...
				  <div class="box">
					...
					<div class="box-body">
						...
						<div class="flexbox">
							...
							<ul class="flexbox">
								<li><a href="#" class="text-fade">845 <i class="fa fa-comment-o"></i></a></li>
								<li><a href="#" class="text-fade">85K <i class="fa fa-heart-o"></i></a></li>
							</ul>
						</div>
					</div>
...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_social.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:22 GMT -->
</html>
