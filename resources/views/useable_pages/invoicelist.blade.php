...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/invoicelist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:42 GMT -->
<head>
  <meta charset="utf-8">
							...
							<table id="example" class="text-fade table table-lg invoice-archive">
								...
								<tbody>
									<tr>
										...
										<td>
											<span class="badge badge-success-light">Paid on Mar 16, 2021</span>
										</td>
										<td>
										...
										<td class="text-center">
											<div class="list-icons d-inline-flex">
												<a href="#" class="list-icons-item me-10 text-fade hover-primary"><i class="fs-18 fa fa-eye-slash"></i></a>
												<div class="list-icons-item dropdown">
													<a href="#" class="list-icons-item dropdown-toggle text-fade hover-primary" data-bs-toggle="dropdown"><i class="fs-18 fa fa-file-text"></i></a>
									...
									<tr>
										...
										<td>
											<span class="badge badge-warning-light">5 days</span>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<span class="badge badge-primary-light">27 days</span>
										</td>
										<td>
