...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:18 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Blog Widgets</title>
	  ...
	  <div class="container-full">
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-12">
					<div class="news-slider owl-carousel" data-nav-dots="false" data-autoplay="true"  data-items="4" data-md-items="2" data-sm-items="1" data-xs-items="1" data-xx-items="1">
						<div class="item">
							<div class="blog-post rounded overflow-hidden">
								<div class="entry-image clearfix">
									<img class="img-fluid" src="../../../images/gallery/thumb-sm/1.jpg" alt="">
								</div>
								<div class="blog-detail">
									...
									<div class="entry-content">
										<p class="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus fuga laborum totam itaque architecto! Laudantium sed delectus assumenda, doloribus non.</p>
									</div>
									<div class="entry-share d-flex justify-content-between align-items-center">
										...
										<div class="social">
											...
											<ul class="list-unstyled">
												...
												<li>
													<a href="#" class="text-mute hover-primary"> <i class="fa-brands fa-x-twitter"></i> </a>
												</li>
												<li>
						...
						<div class="item">
							<div class="blog-post rounded overflow-hidden">
								<div class="entry-image clearfix">
									<img class="img-fluid" src="../../../images/gallery/thumb-sm/2.jpg" alt="">
								</div>
								<div class="blog-detail">
									<div class="entry-title mb-10">
										<a href="#">Blog Post With Image</a>
						...
						<div class="item">
							<div class="blog-post rounded overflow-hidden">
								<div class="entry-image clearfix">
									<img class="img-fluid" src="../../../images/gallery/thumb-sm/3.jpg" alt="">
								</div>
								<div class="blog-detail">
									<div class="entry-title mb-10">
										<a href="#">Blog Post With Image</a>
						...
						<div class="item">
							<div class="blog-post rounded overflow-hidden">
								<div class="entry-image clearfix">
									<img class="img-fluid" src="../../../images/gallery/thumb-sm/4.jpg" alt="">
								</div>
								<div class="blog-detail">
									<div class="entry-title mb-10">
										<a href="#">Blog Post With Image</a>
						...
						<div class="item">
							<div class="blog-post rounded overflow-hidden">
								<div class="entry-image clearfix">
									<img class="img-fluid" src="../../../images/gallery/thumb-sm/5.jpg" alt="">
								</div>
								<div class="blog-detail">
									<div class="entry-title mb-10">
										<a href="#">Blog Post With Image</a>
				...
				<div class="blog-post rounded overflow-hidden">
					<div class="entry-image clearfix">
						<div class="owl-carousel bottom-dots-center owl-theme" data-nav-dots="true" data-autoplay="true"  data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
							<div class="item">
								<img src="../../../images/gallery/thumb-sm/2.jpg" alt="">
							</div>
							<div class="item">
								<img src="../../../images/gallery/thumb-sm/3.jpg" alt="">
							</div>
							<div class="item">
								<img src="../../../images/gallery/thumb-sm/4.jpg" alt="">
							</div>
						</div>
					</div>
					<div class="blog-detail">
				...
				<div class="blog-post rounded overflow-hidden">
					<div class="entry-image clearfix">
						<ul class="grid-post list-unstyled">
							...
							<li>
								<img class="img-fluid" src="../../../images/gallery/thumb-sm/7.jpg" alt="">
							</li>
							<li>
								<img class="img-fluid" src="../../../images/gallery/thumb-sm/9.jpg" alt="">
							</li>
							<li>
								<img class="img-fluid" src="../../../images/gallery/thumb-sm/5.jpg" alt="">
							</li>
			...
			<div class="col-xl-4 col-md-6 col-12">					
				<div class="blog-post rounded overflow-hidden">
					<div class="blog-entry-html-video clearfix">
						<video style="width:100%;height:100%;" id="player1" poster="../../../images/gallery/thumb-sm/10.jpg" controls preload="none">
							<source type="video/mp4" src="video/video.html" />
							<source type="video/webm" src="video/video-2.html" />
							<source type="video/ogg" src="video/video-3.html" />
						</video>
					</div>
					<div class="blog-detail">
						<div class="entry-title mb-10">
				  ...
				  <div class="row g-0">
					<div class="col-md-8">
					  <div class="box-body">
						...
						<p class="text-gray-600">Vestibulum volutpat, ante sit amet dignissim imperdiet, diam diam sodales orci, in gravida lorem erat eu diam. Nulla lorem nunc, ultrices ac dignissim et, dignissim nec lacus. Praesent euismod lorem eget justo lacinia rutrum sed at mi.</p>
				...
				<div class="box">
				  <div class="box-body p-0">				  	
						...
						<p class="mt-0 mb-5 px-30 py-10 bg-gray-300 text-mute">
						  <i class="fa fa-user"></i> by <a href="#" class="text-mute">John</a> 
						  | <i class="fa fa-calendar"></i> Sept 16th, 2018
						  | <i class="fa fa-comment"></i> <a href="#" class="text-mute">3 Comments</a>
						  | <i class="fa fa-share"></i> <a href="#" class="text-mute">39 Shares</a>
						</p>
						<div class="media">
						  <img class="align-self-start w-160" src="../../../images/gallery/thumb-sm/5.jpg" alt="Generic placeholder image">
						  <div class="media-body">
							<p class="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate. Quisque mauris augue, molestie tincidunt condimentum vitae, gravida a libero.</p>
				  ...
				  <div class="box-body">
					...
					<div class="flexbox align-items-center mt-3">
					  <div class="btn-group">
						...
						<a class="btn btn-xs btn-twitter" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="Share Twitter"><i class="fa-brands fa-x-twitter"></i></a>
				  ...
				  <div class="box-body">
					...
					<div class="flexbox align-items-center mt-3">
					  <div class="btn-group">
						...
						<a class="btn btn-xs" href="#" data-bs-toggle="tooltip" title="" data-bs-original-title="Share Twitter"><i class="fa-brands fa-x-twitter"></i></a>
			  ...
			  <div class="col-md-6">
				<div class="box">
				  ...
				  <div class="box-body">
					...
					<p class="text-gray-600">Vestibulum volutpat, ante sit amet dignissim imperdiet, diam diam sodales orci, in gravida lorem erat eu diam. Nulla lorem nunc, ultrices ac dignissim et, dignissim nec lacus. Praesent euismod.</p>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/widget-blog.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/widgets_blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:49:20 GMT -->
</html>
