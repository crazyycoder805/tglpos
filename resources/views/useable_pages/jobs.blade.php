...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/jobs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:50:40 GMT -->
<head>
  <meta charset="utf-8">
					...
					<div class="box">
						<div class="box-body">	
							...
							<div class="mt-20">
								...
								<p class="text-fade">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
								...
								<div class="mt-10 d-flex justify-content-between align-items-center">
									<a href="jobs_details.html" class="waves-effect waves-light btn btn-primary mb-5">View Applications</a>
