...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/ui_typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:44 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Typography </title>
				...
				<div class="col-xl-4">
					<div class="card">
						<div class="card-body">
							...
							<div class="tab-content">
								<div class="tab-pane show active text-fade" id="unordered-preview">
									<ul>
										<li>
				...
				<div class="col-xl-4">
					<div class="card">
						<div class="card-body">
							...
							<div class="tab-content">
								<div class="tab-pane show text-fade active" id="ordered-preview">
									<ol>
										<li>
											Lorem ipsum dolor sit amet
										</li>
				...
				<div class="col-xl-4">
					<div class="card">
						<div class="card-body">
							...
							<div class="tab-content">
								<div class="tab-pane show text-fade active" id="unstyled-preview">
									...
									<ul class="list-inline text-fade">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<div class="tab-content">
								<div class="tab-pane show text-fade active" id="description-list-preview">
									<dl class="row mb-0">
			  ...
			  <div class="box">
				...
				<div class="box-body">
				  <blockquote class="blockquote">
					  <p class="text-fade">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
