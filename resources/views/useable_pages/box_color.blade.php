...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/box_color.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:34 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Box color </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Box Color</h4>
		...
		<section class="content">
			...
			<div class="row">
			  ...
			  <div class="col-12">
				<div class="box bg-primary-light">
				  <div class="box-body">
					...
					<p class="text-gray-600">Each box can accpet <code>.box-*</code> class that <b>*</b> is a <a href="https://bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/ui/general.html" target="_blank">color name</a>. To make the color texts white, you should also add <code>.box-inverse</code> to the <em>.box</em> tag.</p>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-primary-light">
				  <div class="box-header with-border">
					<h4 class="box-title text-primary"><strong>Primary</strong></h4>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-success-light">
				  <div class="box-header">
					<h4 class="box-title text-success"><strong>Success</strong></h4>
					<div class="box-tools pull-right">					
						<ul class="box-controls">
						  <li><a class="box-btn-close" href="#"></a></li>
						</ul>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-info-light">
				  <div class="box-header">
					<h4 class="box-title text-info"><strong>Info</strong></h4>
					<div class="box-tools pull-right">					
						<ul class="box-controls">
						  <li><a class="box-btn-close" href="#"></a></li>
						</ul>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-warning-light">
				  <div class="box-header">
					<h4 class="box-title text-warning"><strong>Warning</strong></h4>
					<div class="box-tools pull-right">					
						<ul class="box-controls">
						  <li><a class="box-btn-close" href="#"></a></li>
						</ul>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-danger-light">
				  <div class="box-header">
					<h4 class="box-title text-danger"><strong>Danger</strong></h4>
					<div class="box-tools pull-right">					
						<ul class="box-controls">
						  <li><a class="box-btn-close" href="#"></a></li>
						</ul>
			...
			<div class="row">
			  ...
			  <div class="col-12">
				<div class="box">
				  <div class="box-body bg-primary-light">
			  ...
			  <div class="col-md-6 col-12">
				<div class="box box-solid">
				  ...
				  <div class="box-body">
					<p class="text-fade">Which is the same as saying through shrinking from toil and pain.</p>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-md-6 col-12">
				<div class="box">
				  <div class="box-header bg-secondary-light">
			...
			<div class="row">
			  ...
			  <div class="col-12">
				<div class="box bg-primary-light">
				  <div class="box-body">
					  <h4>Outline boxs</h4>
					<p class="text-gray-600">Each box can accpet <code>.box-outline-*</code> class that <b>*</b> is a color name.</p>
				  </div>
				</div>
			  </div>
			...
			<div class="row">
			  ...
			  <div class="col-12">
				<div class="box bg-primary-light">
				  <div class="box-body">
					  <h4>Bordery boxs</h4>
					<p class="text-gray-600">You are able to add borders to any side of a box. In some cases, you might want to have a 3px border in one side of a box.</p>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="col-md-6">
				<div class="box bs-3 border-primary">
				  ...
				  <div class="box-body">
					...
					<p class="text-gray-600">Which is the same as saying through shrinking from toil and pain.</p>
				  </div>
				</div>
			  </div>
