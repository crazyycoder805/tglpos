...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-11.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:15 GMT -->
<head>
		<meta charset="utf-8">
				...
				<section class="content">
					<div class="row">
							...
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-start">
										<div>
											<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/food/order-food.svg" class="w-80 me-20" alt="" />
										</div>
										<div>
											<h2 class="my-0 fw-700">89</h2>
											<p class="text-fade mb-5">Total Order</p>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-start">
										<div>
											<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/food/scooter.svg" class="w-80 me-20" alt="" />
										</div>
										<div>
											<h2 class="my-0 fw-700">899</h2>
											<p class="text-fade mb-5">Total Delivered</p>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-start">
										<div>
											<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/food/shopping-bag.svg" class="w-80 me-20" alt="" />
										</div>
										<div>
											<h2 class="my-0 fw-700">59</h2>
											<p class="text-fade mb-5">Total Canceled</p>
											<p class="fs-12 mb-0 text-danger"><span class="badge badge-pill badge-danger-light me-5"><i class="fa fa-arrow-down"></i></span>2% (15 Days)</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-3 col-lg-6 col-12">
							<div class="box pull-up">
								<div class="box-body">
									<div class="d-flex align-items-start">
										<div>
											<img src="https://bsinx-dashboard-template.multipurposethemes.com/bs5/images/food/online-payment.svg" class="w-80 me-20" alt="" />
										</div>
										<div>
											<h2 class="my-0 fw-700">$789k</h2>
											<p class="text-fade mb-5">Total Revenue</p>
											<p class="fs-12 mb-0 text-danger"><span class="badge badge-pill badge-danger-light me-5"><i class="fa fa-arrow-down"></i></span>12% (15 Days)</p>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xxl-4 col-xl-6  col-12">
							<div class="box">
								<div class="box-body">
									<h4 class="box-title fw-500">Order Overview</h4>
							...
							<div class="box">
								...
								<div class="box-body">
									<div class="d-md-flex justify-content-between align-items-center">
										<div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
											<div class="text-start">
												<img src="../../../images/food/biryanis.jpg" class="rounded10 w-80 me-10" alt="">
											</div>
											<div>
										...
										<div>
											<div class="text-start w-90">
												<h4 class="box-title mb-0 fw-500">158</h4>
									...
									<div class="d-md-flex justify-content-between align-items-center">
										<div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
											<div class="text-start">
												<img src="../../../images/food/burgers.jpg" class="rounded10 w-80 me-10" alt="">
											</div>
											<div>
										...
										<div>
											<div class="text-start w-90">
												<h4 class="box-title mb-0 fw-500">18</h4>
									...
									<div class="d-md-flex justify-content-between align-items-center">
										<div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
											<div class="text-start">
												<img src="../../../images/food/dals.jpg" class="rounded10 w-80 me-10" alt="">
											</div>
											<div>
										...
										<div>
											<div class="text-start w-90">
												<h4 class="box-title mb-0 fw-500">258</h4>
									...
									<div class="d-md-flex justify-content-between align-items-center">
										<div class="d-flex justify-content-start align-items-center mb-20 mb-md-0">
											<div class="text-start">
												<img src="../../../images/food/noodles.jpg" class="rounded10 w-80 me-10" alt="">
											</div>
											<div>
										...
										<div>
											<div class="text-start w-90">
												<h4 class="box-title mb-0 fw-500">58</h4>
						...
						<div class="col-xxl-4 col-12">
							<div class="box">
								<div class="box-header no-border pb-15">
									<h4 class="box-title">
										Trending Keyword
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard11.js"></script>

	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-11.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:16 GMT -->
</html>
