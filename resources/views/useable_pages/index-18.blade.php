...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-18.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:26 GMT -->
<head>
		<meta charset="utf-8">
		...
		<div class="content-wrapper">
			<div class="container-full">
				...
				<section class="content">
						<div class="row">
							<div class="col-xxl-3 col-xl-6 col-md-6 col-12">
								<div class="box pull-up ">
									<div class="box-body py-0">
										<div class="d-flex align-items-center justify-content-between ">
											<div>
												<p class="text-mute mb-0">JCB Tractor</p>
												<h3 class="text-dark mb-0 mt-1 fw-600">$350/h</h3>
											</div>
									...
									<div class="box-body py-0">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h3 class="text-dark mb-0 mt-1 fw-600">$400/h</h3>
											</div>
											<div class="img-updown">
									...
									<div class="box-body py-0">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h3 class="text-dark mb-0 mt-1 fw-600">$450/h</h3>
											</div>
											<div class="img-updown">
							...
							<div class="col-xxl-3 col-xl-6 col-md-6 col-12">
								<div class="box pull-up bg-warning">
									<div class="box-body  py-0">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												<p class="text-mute mb-0 text-white">Total Ticket</p>
												<h3 class="text-dark mb-0 mt-1 fw-600 text-white">600</h3>
											</div>
											<div class="img-updown">
						...
						<div class="row">
							...
							<div class="col-xxl-4 col-12">
								<div class="box overflow-hidden">
									<div class="box-header with-border">
										<h4 class="box-title fw-600">Maintenance</h4>
								...
								<div class="box">
									<div class="d-flex justify-content-between box-header">
										...
										<ul class="d-flex list-unstyled"> 
                                          <li><i class="fa fa-circle text-primary f-12"></i>  Open Ticket</li>
                                          <li class="ms-2"><i class="fa fa-circle text-danger f-12"></i> Close Ticket</li>
                                        </ul>
									</div>
									<div class="box-body">
										<div class="row">
							...
							<div class="col-xxl-8">
							  	<div class="box">
									<div class="box-header with-border">
									  	<h4 class="box-title fw-600">Resent Ticket</h4>
										  ...
										  <table class="table table-hover mb-0">
											...
											<tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border-0"><span class="badge badge-pill badge-warning">Panding</span></td>
                                                </tr>
                                            </tbody>
										  </table>
										</div>
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard18.js"></script>
	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-18.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:28 GMT -->
</html>
