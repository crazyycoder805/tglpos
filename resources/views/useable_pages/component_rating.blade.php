...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_rating.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:48 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Range Slider </title>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">This is the most basic example of ratings.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Used when we want starts with a saved rating.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Changes the number of stars.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Change the maximum of stars that can be created.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">You can prevent users to vote. It can be applied with or without score.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">If readOnly is enabled and there is no score, the hint "Not rated yet!" will be shown for all stars.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Add a cancel button on the left side of the stars to cancel the score.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">You can change the space between the star and make them conjusted.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">You can turn on just the mouseovered star instead all from the first until that one.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Enables the half star mouseover to be possible vote with half values.</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<p class="text-fade">Changes the color of the half star.</p>
					...
					<div class="box">
						<div class="box-body">
							...
							<ul class="list-unstyled mb-20">
								<li class="text-gray-500">Down: score &lt;= x.25 the star will be rounded down;</li>
								<li class="text-gray-500">Half: score &gt;= x.26 and &lt;= x.75 the star will be a half star;
								</li>
								<li class="text-gray-500">Up: score &gt;= x.76 the star will be rounded up.</li>
							</ul>
				...
				<div class="col-md-6 col-sm-12">
					<div class="box">
						<div class="box-body">
							...
							<ul class="list-unstyled mb-20">
								<li class="text-gray-500">Down: score &lt; x.6 the star will be rounded down;</li>
								<li class="text-gray-500">Up: score &gt;= x.6 the star will be rounded up;</li>
							</ul>
...
<!-- ./wrapper -->
    ...
    <script src="../../../assets/icons/feather-icons/feather.min.js"></script>	<script src="../../../assets/vendor_components/raty-master/lib/jquery.raty.js"></script>

	<!-- Bsinx Admin App -->
	<script src="../src/js/demo.js"></script>
	<script src="../src/js/template.js"></script>
	
    <script src="../src/js/pages/component-rating-init.js"></script>
