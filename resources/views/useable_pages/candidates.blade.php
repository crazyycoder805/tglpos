...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/candidates.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:51:23 GMT -->
<head>
  <meta charset="utf-8">
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-md-flex align-items-center justify-content-between">
				<div>
					<a href="jobs_details.html" class="waves-effect waves-light btn btn-outline btn-primary">Jobs</a>
								...
								<thead>
									<tr>
										<th>
											...
											<label for="ch_bx_1" class="mt-0"></label>
										</th>
										<th>Name</th>
										<th>Status</th>
								...
								<tbody class="text-fade">
									<tr>
										<td>
											...
											<label for="ch_bx_2" class="mt-2"></label>
										</td>
										<td>Nil Yeager</td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_3" class="mt-2"></label>
										</td>
										<td>Aditi Row</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_4" class="mt-2"></label>
										</td>
										<td>Mical Doe</td>
										<td>Awaiting Review</td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_5" class="mt-2"></label>
										</td>
										<td>Shone Marsh</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-secondary-light">0/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_6" class="mt-2"></label>
										</td>
										<td>Riki Ponting</td>
										<td>Contacting</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_7" class="mt-2"></label>
										</td>
										<td>Gail Doe</td>
										<td>Contacting</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_8" class="mt-2"></label>
										</td>
										<td>Gama Doe</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_9" class="mt-2"></label>
										</td>
										<td>Jaksan Doe</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-secondary-light">0/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_10" class="mt-2"></label>
										</td>
										<td>Vidito Doe</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-secondary-light">0/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_11" class="mt-2"></label>
										</td>
										<td>Jamkon Doe</td>
										<td>Contacting</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_12" class="mt-2"></label>
										</td>
										<td>Micalrow Doe</td>
										<td>Contacting</td>
										<td><span class="badge badge-success-light">1/1 Preferred Question met</span></td>
									...
									<tr>
										<td>
											...
											<label for="ch_bx_13" class="mt-2"></label>
										</td>
										<td>Nil Yeager</td>
										<td>Awaiting Review</td>
										<td><span class="badge badge-secondary-light">0/1 Preferred Question met</span></td>
