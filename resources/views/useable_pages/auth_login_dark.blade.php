...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/auth_login_dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:50:00 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Log in </title>
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-gray-800 rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0 text-fade">Sign in to continue to Bsinx Admin.</p>							
							</div>
							<div class="p-40">
								<form action="https://bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index.html" method="post">
