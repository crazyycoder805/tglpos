...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:06 GMT -->
<head>
		<meta charset="utf-8">
			...
			<div class="container-full">
				...
				<section class="content">			
							...
							<div class="box bg-primary-light pull-up">
								<div class="box-body p-xl-0">							
									<div class="row align-items-center">
										<div class="col-12 col-lg-3"><img src="../../../images/svg-icon/color-svg/online-discussion.png" alt=""></div>
										<div class="col-12 col-lg-9 py-15">
											<h2 class="fw-600">Hello Johen, Welcome Back!</h2>
						...
						<div class="col-xl-3 col-12">
							<div class="box bg-transparent no-shadow">
								<div class="box-body p-xl-0 text-center">							
									...
									<button type="button" class="waves-effect waves-light w-p100 btn btn-primary"><i class="fa fa-plus me-15"></i> Cheate New Course</button>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
							...
							<div class="row fx-element-overlay">
									...
									<div class="box pull-up">
										<div class="box-body">
											<div class="d-flex align-items-center">
												<img src="../../../images/svg-icon/cor-logo-6.png" alt="" class="align-self-end h-60 w-60 bg-light me-5">
												<div class="d-flex flex-column flex-grow-1">
													<h5 class="mb-1">Angular Class</h5>
													<p class="text-fade m-0">20 Courses</p>
												</div>
											</div>
											<div class="d-flex justify-content-between align-items-center">
												<div>
													<p class="m-0 text-fade fw-500">Rate</p>
													<h5 class="m-0"><i class="fa-solid fa-star text-warning fs-16"></i> 4.8</h5>
												</div>
												<div>
								...
								<div class="col-lg-4 col-md-6 col-12">
									<div class="box pull-up">
										<div class="box-body">
											<div class="d-flex align-items-center">
												<img src="../../../images/svg-icon/cor-logo-5.png" alt="" class="align-self-end h-60 w-60 bg-light me-5">
												<div class="d-flex flex-column flex-grow-1">
													<h5 class="mb-1">Android Class</h5>
													<p class="text-fade m-0">10 Courses</p>
												</div>
											</div>
											<div class="d-flex justify-content-between align-items-center">
												<div>
													<p class="m-0 text-fade fw-500">Rate</p>
													<h5 class="m-0"><i class="fa-solid fa-star text-warning fs-16"></i> 5.0</h5>
												</div>
												<div>
													<p class="m-0 text-fade fw-500">Type</p>
													<h5 class="m-0">Development</h5>
								...
								<div class="col-lg-4 col-md-6 col-12">
									<div class="box pull-up">
										<div class="box-body">
											<div class="d-flex align-items-center">
												<img src="../../../images/svg-icon/cor-logo-4.png" alt="" class="align-self-end h-60 w-60 bg-light me-5">
												<div class="d-flex flex-column flex-grow-1">
													<h5 class="mb-1">Python Class</h5>
													<p class="text-fade m-0">18 Courses</p>
												</div>
											</div>
											<div class="d-flex justify-content-between align-items-center">
												<div>
													<p class="m-0 text-fade fw-500">Rate</p>
													<h5 class="m-0"><i class="fa-solid fa-star text-warning fs-16"></i> 4.0</h5>
												</div>
												<div>
													<p class="m-0 text-fade fw-500">Type</p>
													<h5 class="m-0">Development</h5>
						...
						<div class="col-xxl-4">
							<div class="box bg-black image-edubox">
								<div class="box-body">
									<div class="row">
										<div class="col-8">
											<img src="../../../images/logo-white-text.png" alt="logo">
											<h3 class="mt-15 fw-500">Upgrade to Pro</h3>
											<p class="text-fade">Get 1 Month Free on Annual Subscription and Explore.</p>
											<div>
												<button class="btn btn-success waves-effect rounded-5 px-25">Get Access</button>
											</div>
										</div>
										<div class="col-4 book-image align-content-center text-center">
											<img src="../../../images/svg-icon/book-3.png" alt="">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xl-8 col-lg-7 col-12">
							<div class="box bg-transparent no-shadow mb-15">
								<div class="box-header no-border d-flex justify-content-between align-items-center pb-0 px-0">
									...
									<div class="dropdown">
										<button class="btn btn-secondary te py-5 dropdown-toggle sem-drop" type="button" data-bs-toggle="dropdown" aria-expanded="false">Active </button>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="me-15 bg-primary-light h-50 w-50 l-h-40 rounded text-center">
												<img src="../../../images/svg-icon/lesson.png" alt="" class="align-self-end h-50 w-50">
											</div>
										...
										<div>
											<p class="m-0 text-fade">panding</p>
											<h5 class="m-0">2h 20 min</h5>
										</div>
										<div class="d-none d-md-block">
											<span class="donut" data-peity="{ &quot;fill&quot;: [&quot;#17b3a3&quot;, &quot;#f3f5f6&quot;], &quot;innerRadius&quot;: 24, &quot;radius&quot;: 28 }" style="display: none;">1,3</span><svg class="peity" height="56" width="56"><path d="M 28 0 A 28 28 0 0 1 56 28 L 52 28 A 24 24 0 0 0 28 4" fill="#17b3a3"></path><path d="M 56 28 A 28 28 0 1 1 27.999999999999996 0 L 27.999999999999996 4 A 24 24 0 1 0 52 28" fill="#f3f5f6"></path></svg> 25%
										</div>
									</div>
								</div>
							</div>
							<div class="box mb-15 pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="me-15 bg-warning-light h-50 w-50 l-h-40 rounded text-center">
												<img src="../../../images/svg-icon/pencils.png" alt="" class="align-self-end h-50 w-50">
											</div>
											<div class="d-flex flex-column fw-500">
										...
										<div>
											<p class="m-0 text-fade">panding</p>
											<h5 class="m-0">5h 30 min</h5>
										</div>
										<div class="d-none d-md-block">
											<span class="donut" data-peity="{ &quot;fill&quot;: [&quot;#17b3a3&quot;, &quot;#f3f5f6&quot;], &quot;innerRadius&quot;: 24, &quot;radius&quot;: 28 }" style="display: none;">2,2</span><svg class="peity" height="56" width="56"><path d="M 28 0 A 28 28 0 0 1 28 56 L 28 52 A 24 24 0 0 0 28 4" fill="#17b3a3"></path><path d="M 28 56 A 28 28 0 0 1 27.999999999999996 0 L 27.999999999999996 4 A 24 24 0 0 0 28 52" fill="#f3f5f6"></path></svg> 50%
										</div>
									</div>
								</div>
							</div>
							<div class="box mb-15 pull-up">
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="me-15 bg-danger-light h-50 w-50 l-h-40 rounded text-center">
												<img src="../../../images/svg-icon/art-2.png" alt="" class="align-self-end h-50 w-50">
											</div>
											<div class="d-flex flex-column fw-500">
										...
										<div>
											<p class="m-0 text-fade">panding</p>
											<h5 class="m-0">6h 40 min</h5>
										</div>
										<div class="d-none d-md-block">
											<span class="donut" data-peity="{ &quot;fill&quot;: [&quot;#17b3a3&quot;, &quot;#f3f5f6&quot;], &quot;innerRadius&quot;: 24, &quot;radius&quot;: 28 }" style="display: none;">8,3</span><svg class="peity" height="56" width="56"><path d="M 28 0 A 28 28 0 1 1 0.2849996273338853 31.984815471651984 L 4.2442853948576165 31.415556118558843 A 24 24 0 1 0 28 4" fill="#17b3a3"></path><path d="M 0.2849996273338853 31.984815471651984 A 28 28 0 0 1 27.999999999999996 0 L 27.999999999999996 4 A 24 24 0 0 0 4.2442853948576165 31.415556118558843" fill="#f3f5f6"></path></svg> 75%
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-12">														
									<div class="box no-shadow mb-0 bg-transparent">
										<div class="box-header px-0 b-0">
											<h3 class="fw-500 m-0 fs-22">Hours Spent</h3>
										</div>
									</div>
								</div>
								<div class="col-12">
									<div class="box">
										<div class="box-header d-flex justify-content-between align-items-center b-0 pb-0">
											<div class="d-flex">
												<p class="m-0 pe-5 text-fade"><i class="fa-solid fa-stop text-primary"></i> Study </p>
												<p class="m-0 text-fade"><i class="fa-solid fa-stop text-light"></i> Exams</p>
											</div>
											<div class="dropdown">
												<button class="btn btn-secondary py-1 dropdown-toggle sem-drop" type="button" data-bs-toggle="dropdown" aria-expanded="false">Monthly </button>
												<div class="dropdown-menu dropdown-menu-end" style="">
							...
							<div class="col-12">														
								<div class="box no-shadow mb-0 bg-transparent">
									<div class="box-header no-border px-0">
										<h3 class="box-title">Current Running Courses</h3>	
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard6.js"></script>

	
</body>

<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:09 GMT -->
</html>
