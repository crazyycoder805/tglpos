...
<!-- Mirrored from bsinx-dashboard-template.multipurposethemes.com/bs5/template/vertical/main-dark/component_media_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 07:48:47 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>Bsinx Admin - Dashboard  Advanced medias </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Advanced Medias</h4>
		...
		<section class="content">
			<div class="row">
				...
				<div class="col-md-4 col-12">
					<div class="media bg-white mb-20 align-items-center">
					  <span class="fs-36 text-primary icon-Active-call"><span class="path1"></span><span class="path2"></span></span>
					  <div class="media-body">
				...
				<div class="col-md-4 col-12">
					<div class="media bg-white mb-20 align-items-center">
					  <div class="media-body">
						<p><strong>Nil Yeager@gmail.com</strong></p>
						<p>Work</p>
					  </div>
					 <span class="fs-36 text-primary icon-Mail"><span class="path1"></span><span class="path2"></span></span>
					</div>				
				</div>
				...
				<div class="col-md-6 col-12">
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						<p><strong>Nil Yeager</strong> <time class="float-end text-fade" datetime="2023-07-14 20:00">24 min ago</time></p>
						<p class="text-fade">Donec vitae laoreet neque, id convallis ante.</p>
						<div class="d-inline-block pull-right mt-10">
						  <button type="button" class="btn btn-rounded btn-sm btn-success m-5 btn-outline">Approve</button>
						  <button type="button" class="btn btn-rounded btn-sm btn-danger m-5 btn-outline">Delete</button>
						</div>
					  </div>
					</div>				
				</div>		
					...
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						...
						<ul class="list-inline mt-10">
							<li><a href="#" class="link-black text-sm text-fade">Comments (5) </a></li> 
							<li><a href="#" class="link-black text-sm text-fade"> likes (23)</a></li>
							<li class="pull-right">
					  ...
					  <div class="media-body">
						...
						<ul class="list-inline mt-10">
							...
							<li class="pull-right media-hover-show">
								<button type="button" class="btn btn-box-tool btn-xs py-0" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit"><i class="fa fa-pencil"></i></button>
								<button type="button" class="btn btn-box-tool btn-xs py-0" data-bs-toggle="tooltip" title="" data-bs-original-title="Delete"><i class="fa fa-trash"></i></button>
							</li>
						</ul>						
				...
				<div class="col-md-4 col-12">
					<div class="media bg-white align-items-center mb-20">
					  <div class="media-body">
						<p><strong>Notifications</strong></p>
						<p class="text-fade">Turn on to receive alerts</p>
					  </div>
				...
				<div class="col-md-4 col-12">
					<div class="media bg-white align-items-center mb-20">
					  <img class="avatar avatar-xl" src="../../../images/avatar.png" alt="...">
					  <div class="media-body">
						<h4><strong>Nil Yeager</strong></h4>
						<p class="text-fade">Manager</p>
					  </div>
					</div>				
				</div>			
				...
				<div class="col-md-4 col-12">
					<div class="media align-items-center bg-white mb-20">
					  <img class="avatar avatar-xl" src="../../../images/avatar2.png" alt="...">
					  <div class="media-body">
						<p><strong>Nil Yeager</strong></p>
						<p>CEO</p>
					  </div>
				...
				<div class="col-md-4 col-12">
					<div class="media align-items-center bg-white mb-20">
					  <img class="avatar avatar-xl" src="../../../images/avatar3.png" alt="...">
					  <div class="media-body">
						<p><strong>Nil Yeager</strong></p>
						<p>@Nil Yeager</p>
					  </div>
					  <div>
						<a class="btn btn-primary-light btn-sm" href="#">Follow</a>
					  </div>
					</div>				
				</div>		
				...
				<div class="col-md-4 col-12">
					<div class="media align-items-center bg-white mb-20">
					  <span class="avatar avatar-xl bg-primary"><i class="fa fa-user"></i></span>
					  <div class="media-body">
						<p>New user registered</p>
						<time datetime="2023-07-14 20:00" class="text-fade">24 min ago</time>
					  </div>
					</div>				
				</div>		
				...
				<div class="col-md-4 col-12">
					<div class="media align-items-center bg-white mb-20">
					  <span class="avatar avatar-xl bg-primary"><i class="fa fa-folder"></i></span>
					  <div class="media-body">
						<p><strong>Photos</strong></p>
						<time datetime="2023-07-14 20:00" class="text-fade">Nov 22, 2018</time>
					  </div>
					  <div>
				...
				<div class=" col-md-4 col-12">
					<div class="media align-items-center bg-white mb-20">
					  ...
					  <div class="media-body">
						<p><strong>Nil Yeager</strong> <time class="float-end text-fade" datetime="2023-07-14 20:00">24 min ago</time></p>
						<p class="text-fade">Updated his profile picture</p>
					  </div>
					</div>				
				</div>	
				...
				<div class="col-md-4 col-12">
					<div class="media bg-white mb-20">
					  ...
					  <div class="media-body">
						...
						<p>
						  <strong class="fs-14 semibold">Nil Yeager</strong>
				...
				<div class="col-md-4 col-12">
					<div class="media flex-column text-center p-40 bg-white mb-20">
					  ...
					  <div class="mt-20">
						  ...
						  <small class="text-fade">You task has been completed.</small>
					  </div>
					</div>				
				</div>		
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/media.js"></script>
